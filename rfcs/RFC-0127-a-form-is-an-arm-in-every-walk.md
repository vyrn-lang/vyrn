...
1,094 mentions in eight files for 38 forms. The table is generated by
...
| `Expr::Unary` | 4 | 4 | 4 | 1 | 7 | 1 | 1 | 1 | 23 |
| `Expr::Binary` | 3 | 3 | 6 | 2 | 8 | 2 | 1 | 0 | 25 |
| `Expr::Call` | 22 | 12 | 23 | 2 | 26 | 3 | 11 | 0 | 99 |
| `Expr::Match` | 8 | 5 | 11 | 2 | 9 | 1 | 3 | 0 | 39 |
| `Expr::IfExpr` | 1 | 4 | 10 | 1 | 8 | 1 | 1 | 0 | 26 |
| `Expr::Try` | 1 | 3 | 4 | 1 | 6 | 1 | 3 | 0 | 19 |
| `Expr::StructLit` | 2 | 4 | 6 | 1 | 9 | 1 | 2 | 0 | 25 |
| `Expr::Field` | 6 | 3 | 13 | 1 | 14 | 1 | 2 | 0 | 40 |
| `Expr::TryConstruct` | 1 | 4 | 3 | 1 | 5 | 1 | 3 | 0 | 18 |
| `Expr::ArrayLit` | 5 | 3 | 4 | 1 | 9 | 2 | 3 | 1 | 28 |
| `Expr::MapLit` | 3 | 3 | 4 | 1 | 6 | 2 | 2 | 0 | 21 |
| `Expr::Spawn` | 1 | 6 | 3 | 1 | 7 | 1 | 4 | 0 | 23 |
| `Expr::Lambda` | 1 | 7 | 7 | 2 | 9 | 3 | 8 | 1 | 38 |
...
An expression's floor is 18 (`Expr::TryConstruct`), and it is higher for the
