...
982 mentions in eight files for 38 forms. The table is generated by
...
|---|---|---|---|---|---|---|---|---|---|
| `Stmt::Let` | 8 | 6 | 3 | 0 | 9 | 2 | 4 | 1 | 33 |
| `Stmt::Assign` | 2 | 4 | 2 | 0 | 7 | 1 | 2 | 0 | 18 |
| `Stmt::SetField` | 4 | 4 | 2 | 0 | 6 | 1 | 3 | 0 | 20 |
| `Stmt::IndexSet` | 4 | 4 | 2 | 0 | 6 | 1 | 2 | 0 | 19 |
| `Stmt::Return` | 1 | 6 | 2 | 0 | 8 | 2 | 3 | 1 | 23 |
| `Stmt::Break` | 2 | 2 | 1 | 0 | 8 | 1 | 1 | 0 | 15 |
| `Stmt::Continue` | 1 | 2 | 1 | 0 | 8 | 1 | 1 | 0 | 14 |
| `Stmt::If` | 2 | 4 | 4 | 0 | 8 | 1 | 1 | 0 | 20 |
| `Stmt::IfLet` | 2 | 3 | 4 | 0 | 8 | 2 | 2 | 1 | 22 |
| `Stmt::While` | 2 | 4 | 4 | 0 | 7 | 1 | 1 | 0 | 19 |
| `Stmt::ForIn` | 1 | 5 | 4 | 0 | 7 | 2 | 2 | 1 | 22 |
| `Stmt::Drop` | 1 | 4 | 2 | 0 | 6 | 1 | 2 | 0 | 16 |
| `Stmt::Expr` | 2 | 2 | 2 | 0 | 7 | 1 | 3 | 0 | 17 |
| `Stmt::Region` | 1 | 4 | 3 | 0 | 8 | 1 | 1 | 0 | 18 |
| `Expr::Int` | 4 | 6 | 5 | 0 | 8 | 1 | 3 | 1 | 28 |
| `Expr::Byte` | 2 | 4 | 3 | 0 | 8 | 1 | 3 | 1 | 22 |
| `Expr::Float` | 2 | 4 | 4 | 0 | 8 | 1 | 2 | 1 | 22 |
| `Expr::Bool` | 4 | 2 | 4 | 0 | 8 | 1 | 2 | 1 | 22 |
| `Expr::Str` | 7 | 3 | 4 | 0 | 8 | 1 | 7 | 2 | 32 |
| `Expr::Var` | 25 | 22 | 15 | 0 | 26 | 4 | 30 | 0 | 122 |
| `Expr::Unary` | 4 | 3 | 3 | 0 | 7 | 1 | 1 | 1 | 20 |
| `Expr::Binary` | 3 | 2 | 3 | 1 | 8 | 2 | 1 | 0 | 20 |
