...
912 mentions in eight files for 38 forms. The table is generated by
...
|---|---|---|---|---|---|---|---|---|---|
| `Stmt::Let` | 7 | 5 | 2 | 0 | 7 | 2 | 8 | 0 | 31 |
| `Stmt::Assign` | 3 | 3 | 2 | 0 | 5 | 1 | 5 | 0 | 19 |
| `Stmt::SetField` | 4 | 3 | 2 | 0 | 4 | 1 | 3 | 0 | 17 |
| `Stmt::IndexSet` | 3 | 3 | 2 | 0 | 4 | 1 | 2 | 0 | 15 |
| `Stmt::Return` | 1 | 5 | 2 | 0 | 6 | 2 | 6 | 1 | 23 |
| `Stmt::Break` | 2 | 1 | 1 | 0 | 6 | 1 | 4 | 0 | 15 |
| `Stmt::Continue` | 1 | 1 | 1 | 0 | 6 | 1 | 4 | 0 | 14 |
| `Stmt::If` | 2 | 3 | 3 | 0 | 6 | 1 | 4 | 0 | 19 |
| `Stmt::IfLet` | 2 | 2 | 3 | 0 | 6 | 2 | 5 | 0 | 20 |
| `Stmt::While` | 2 | 3 | 3 | 0 | 5 | 1 | 4 | 0 | 18 |
| `Stmt::ForIn` | 1 | 4 | 3 | 0 | 5 | 2 | 5 | 0 | 20 |
| `Stmt::Drop` | 1 | 3 | 2 | 0 | 4 | 1 | 4 | 0 | 15 |
| `Stmt::Expr` | 2 | 1 | 2 | 0 | 5 | 1 | 6 | 0 | 17 |
| `Stmt::Region` | 1 | 3 | 2 | 0 | 6 | 1 | 1 | 0 | 14 |
| `Expr::Int` | 4 | 6 | 4 | 0 | 7 | 1 | 5 | 1 | 28 |
| `Expr::Byte` | 2 | 4 | 3 | 0 | 7 | 1 | 5 | 1 | 23 |
| `Expr::Float` | 2 | 4 | 3 | 0 | 7 | 1 | 4 | 1 | 22 |
| `Expr::Bool` | 4 | 2 | 3 | 0 | 7 | 1 | 4 | 1 | 22 |
| `Expr::Str` | 7 | 3 | 3 | 0 | 7 | 1 | 9 | 2 | 32 |
| `Expr::Var` | 24 | 22 | 13 | 0 | 25 | 4 | 32 | 0 | 120 |
| `Expr::Unary` | 4 | 3 | 2 | 0 | 5 | 1 | 3 | 1 | 19 |
| `Expr::Binary` | 3 | 2 | 2 | 1 | 6 | 2 | 3 | 0 | 19 |
| `Expr::Call` | 22 | 12 | 9 | 1 | 26 | 3 | 10 | 0 | 83 |
| `Expr::Match` | 8 | 5 | 6 | 0 | 7 | 1 | 3 | 0 | 30 |
| `Expr::IfExpr` | 1 | 3 | 3 | 0 | 6 | 1 | 1 | 0 | 15 |
| `Expr::Try` | 1 | 2 | 2 | 0 | 4 | 1 | 3 | 0 | 13 |
| `Expr::StructLit` | 2 | 3 | 2 | 0 | 7 | 1 | 2 | 0 | 17 |
| `Expr::Field` | 7 | 2 | 10 | 0 | 12 | 1 | 2 | 0 | 34 |
| `Expr::TryConstruct` | 1 | 3 | 2 | 0 | 3 | 1 | 3 | 0 | 13 |
| `Expr::ArrayLit` | 5 | 2 | 2 | 0 | 6 | 2 | 3 | 1 | 21 |
| `Expr::MapLit` | 3 | 2 | 2 | 0 | 4 | 2 | 2 | 0 | 15 |
| `Expr::Spawn` | 1 | 6 | 2 | 0 | 6 | 1 | 4 | 0 | 20 |
| `Expr::Lambda` | 1 | 7 | 4 | 0 | 9 | 3 | 8 | 0 | 32 |
| `Expr::Consume` | 1 | 2 | 4 | 0 | 9 | 1 | 4 | 0 | 21 |
| `Pattern::Variant` | 11 | 4 | 1 | 0 | 1 | 0 | 5 | 0 | 22 |
...
census ran from 7 mentions to 244, a factor of 35. This one runs from 8 to 120,
...
unspellable ones are the cheapest rows in the table: `Pattern::Other` at 8,
`Pattern::Failure` at 10, `Pattern::Success` at 16. They fell by three each when
RFC-0125 §3 M6's binder slice made `ast::Pattern::bindings` the one statement of
what a pattern binds, and by two more when its column slice gave the same
answer to the two emitters, so the checker, the move check, the editor and both
emitters each stopped matching on all four.
