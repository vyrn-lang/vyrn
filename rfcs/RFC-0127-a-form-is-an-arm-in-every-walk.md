...
1,026 mentions in eight files for 38 forms. The table is generated by
...
|---|---|---|---|---|---|---|---|---|---|
| `Stmt::Let` | 8 | 6 | 3 | 0 | 9 | 2 | 7 | 1 | 36 |
| `Stmt::Assign` | 2 | 4 | 2 | 0 | 7 | 1 | 5 | 0 | 21 |
| `Stmt::SetField` | 4 | 4 | 2 | 0 | 6 | 1 | 3 | 0 | 20 |
| `Stmt::IndexSet` | 4 | 4 | 2 | 0 | 6 | 1 | 2 | 0 | 19 |
| `Stmt::Return` | 1 | 6 | 2 | 0 | 8 | 2 | 7 | 1 | 27 |
| `Stmt::Break` | 2 | 2 | 1 | 0 | 8 | 1 | 3 | 0 | 17 |
| `Stmt::Continue` | 1 | 2 | 1 | 0 | 8 | 1 | 3 | 0 | 16 |
| `Stmt::If` | 2 | 4 | 4 | 0 | 8 | 1 | 5 | 0 | 24 |
| `Stmt::IfLet` | 2 | 3 | 4 | 0 | 8 | 2 | 4 | 1 | 24 |
| `Stmt::While` | 2 | 4 | 4 | 0 | 7 | 1 | 3 | 0 | 21 |
| `Stmt::ForIn` | 1 | 5 | 4 | 0 | 7 | 2 | 4 | 1 | 24 |
| `Stmt::Drop` | 1 | 4 | 2 | 0 | 6 | 1 | 4 | 0 | 18 |
| `Stmt::Expr` | 2 | 2 | 2 | 0 | 7 | 1 | 5 | 0 | 19 |
| `Stmt::Region` | 1 | 4 | 3 | 0 | 8 | 1 | 1 | 0 | 18 |
| `Expr::Int` | 4 | 6 | 5 | 0 | 8 | 1 | 5 | 1 | 30 |
| `Expr::Byte` | 2 | 4 | 3 | 0 | 8 | 1 | 5 | 1 | 24 |
| `Expr::Float` | 2 | 4 | 4 | 0 | 8 | 1 | 4 | 1 | 24 |
| `Expr::Bool` | 4 | 2 | 4 | 0 | 8 | 1 | 4 | 1 | 24 |
| `Expr::Str` | 7 | 3 | 4 | 0 | 8 | 1 | 9 | 2 | 34 |
| `Expr::Var` | 25 | 22 | 15 | 0 | 26 | 4 | 32 | 0 | 124 |
| `Expr::Unary` | 4 | 3 | 3 | 0 | 7 | 1 | 3 | 1 | 22 |
| `Expr::Binary` | 3 | 2 | 3 | 1 | 8 | 2 | 3 | 0 | 22 |
| `Expr::Call` | 22 | 12 | 10 | 1 | 26 | 3 | 10 | 0 | 84 |
| `Expr::Match` | 8 | 5 | 7 | 0 | 9 | 1 | 3 | 0 | 33 |
| `Expr::IfExpr` | 1 | 3 | 4 | 0 | 8 | 1 | 1 | 0 | 18 |
| `Expr::Try` | 1 | 2 | 2 | 0 | 6 | 1 | 3 | 0 | 15 |
| `Expr::StructLit` | 2 | 3 | 3 | 0 | 9 | 1 | 2 | 0 | 20 |
| `Expr::Field` | 6 | 2 | 10 | 0 | 14 | 1 | 2 | 0 | 35 |
| `Expr::TryConstruct` | 1 | 3 | 2 | 0 | 5 | 1 | 3 | 0 | 15 |
| `Expr::ArrayLit` | 5 | 2 | 3 | 0 | 8 | 2 | 3 | 1 | 24 |
| `Expr::MapLit` | 3 | 2 | 3 | 0 | 6 | 2 | 2 | 0 | 18 |
| `Expr::Spawn` | 1 | 6 | 2 | 0 | 7 | 1 | 4 | 0 | 21 |
| `Expr::Lambda` | 1 | 7 | 4 | 0 | 11 | 3 | 8 | 1 | 35 |
| `Expr::Consume` | 1 | 2 | 5 | 0 | 11 | 1 | 4 | 0 | 24 |
...
`Stmt::Continue` costs 23 mentions. A `continue` has no operand, no type, no
value, no ownership effect and no diagnostic of its own; the checker asks
whether a loop encloses it and every other pass steps over it. So **23 is the
price of existing**, and the rows above it pay 23 plus what they decide:

| form | all eight | above the floor | what the excess buys |
|---|---|---|---|
| `Stmt::Continue` | 23 | 0 | the floor |
| `Stmt::Drop` | 23 | 0 | RFC-0114's explicit reclaim, and no arm above the floor |
| `Stmt::Break` | 24 | 1 | one more arm, in `own` |
| `Stmt::Let` | 41 | 18 | a binder, a type, a placement, a copy rule |
| `Stmt::Return` | 38 | 15 | the release of every live binding on the way out |
...
279 mentions in seven files. The rows are `Program`'s `Vec` fields, read out of
