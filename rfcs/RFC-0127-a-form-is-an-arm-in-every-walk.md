...
1,008 mentions in eight files for 38 forms. The table is generated by
...
|---|---|---|---|---|---|---|---|---|---|
| `Stmt::Let` | 7 | 6 | 2 | 0 | 9 | 2 | 7 | 1 | 34 |
| `Stmt::Assign` | 3 | 4 | 2 | 0 | 7 | 1 | 5 | 0 | 22 |
| `Stmt::SetField` | 4 | 4 | 2 | 0 | 6 | 1 | 3 | 0 | 20 |
| `Stmt::IndexSet` | 3 | 4 | 2 | 0 | 6 | 1 | 2 | 0 | 18 |
| `Stmt::Return` | 1 | 6 | 2 | 0 | 8 | 2 | 6 | 1 | 26 |
| `Stmt::Break` | 2 | 2 | 1 | 0 | 8 | 1 | 4 | 0 | 18 |
| `Stmt::Continue` | 1 | 2 | 1 | 0 | 8 | 1 | 4 | 0 | 17 |
| `Stmt::If` | 2 | 4 | 3 | 0 | 8 | 1 | 4 | 0 | 22 |
| `Stmt::IfLet` | 2 | 3 | 3 | 0 | 8 | 2 | 5 | 1 | 24 |
| `Stmt::While` | 2 | 4 | 3 | 0 | 7 | 1 | 4 | 0 | 21 |
| `Stmt::ForIn` | 1 | 5 | 3 | 0 | 7 | 2 | 5 | 1 | 24 |
| `Stmt::Drop` | 1 | 4 | 2 | 0 | 6 | 1 | 4 | 0 | 18 |
| `Stmt::Expr` | 2 | 2 | 2 | 0 | 7 | 1 | 6 | 0 | 20 |
| `Stmt::Region` | 1 | 4 | 2 | 0 | 8 | 1 | 1 | 0 | 17 |
| `Expr::Int` | 4 | 6 | 4 | 0 | 8 | 1 | 5 | 1 | 29 |
| `Expr::Byte` | 2 | 4 | 3 | 0 | 8 | 1 | 5 | 1 | 24 |
| `Expr::Float` | 2 | 4 | 3 | 0 | 8 | 1 | 4 | 1 | 23 |
| `Expr::Bool` | 4 | 2 | 3 | 0 | 8 | 1 | 4 | 1 | 23 |
| `Expr::Str` | 7 | 3 | 3 | 0 | 8 | 1 | 9 | 2 | 33 |
| `Expr::Var` | 24 | 22 | 13 | 0 | 26 | 4 | 32 | 0 | 121 |
| `Expr::Unary` | 4 | 3 | 2 | 0 | 7 | 1 | 3 | 1 | 21 |
| `Expr::Binary` | 3 | 2 | 2 | 1 | 8 | 2 | 3 | 0 | 21 |
| `Expr::Call` | 22 | 12 | 9 | 1 | 26 | 3 | 10 | 0 | 83 |
| `Expr::Match` | 8 | 5 | 6 | 0 | 9 | 1 | 3 | 0 | 32 |
| `Expr::IfExpr` | 1 | 3 | 3 | 0 | 8 | 1 | 1 | 0 | 17 |
| `Expr::Try` | 1 | 2 | 2 | 0 | 6 | 1 | 3 | 0 | 15 |
| `Expr::StructLit` | 2 | 3 | 2 | 0 | 9 | 1 | 2 | 0 | 19 |
| `Expr::Field` | 7 | 2 | 10 | 0 | 14 | 1 | 2 | 0 | 36 |
| `Expr::TryConstruct` | 1 | 3 | 2 | 0 | 5 | 1 | 3 | 0 | 15 |
| `Expr::ArrayLit` | 5 | 2 | 2 | 0 | 8 | 2 | 3 | 1 | 23 |
| `Expr::MapLit` | 3 | 2 | 2 | 0 | 6 | 2 | 2 | 0 | 17 |
| `Expr::Spawn` | 1 | 6 | 2 | 0 | 7 | 1 | 4 | 0 | 21 |
| `Expr::Lambda` | 1 | 7 | 4 | 0 | 11 | 3 | 8 | 1 | 35 |
| `Expr::Consume` | 1 | 2 | 4 | 0 | 11 | 1 | 4 | 0 | 23 |
...
census ran from 7 mentions to 244, a factor of 35. This one runs from 13 to 129,
...
than a statement is. A pattern is walked by fewer than either, and one row —
`Pattern::Other` at 13 — is the only one under the statement floor;
`Pattern::Failure` sits exactly on it at 15.
