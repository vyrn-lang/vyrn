...
869 mentions in eight files for 38 forms. The table is generated by
...
| `Stmt::IfLet` | 2 | 2 | 1 | 0 | 6 | 2 | 5 | 1 | 19 |
| `Stmt::While` | 2 | 3 | 1 | 0 | 5 | 1 | 4 | 0 | 16 |
| `Stmt::ForIn` | 1 | 4 | 1 | 0 | 5 | 2 | 5 | 1 | 19 |
...
| `Expr::Var` | 24 | 22 | 4 | 0 | 25 | 4 | 32 | 0 | 111 |
| `Expr::Unary` | 4 | 3 | 1 | 0 | 5 | 1 | 3 | 1 | 18 |
| `Expr::Binary` | 3 | 2 | 1 | 1 | 6 | 2 | 3 | 0 | 18 |
| `Expr::Call` | 22 | 12 | 8 | 1 | 26 | 3 | 10 | 0 | 82 |
...
| `Expr::Lambda` | 1 | 7 | 3 | 0 | 9 | 3 | 8 | 1 | 32 |
| `Expr::Consume` | 1 | 2 | 2 | 0 | 9 | 1 | 4 | 0 | 19 |
| `Pattern::Variant` | 11 | 4 | 1 | 0 | 1 | 1 | 6 | 1 | 25 |
| `Pattern::Success` | 1 | 4 | 2 | 0 | 3 | 1 | 7 | 0 | 18 |
| `Pattern::Failure` | 1 | 3 | 1 | 0 | 2 | 1 | 4 | 0 | 12 |
| `Pattern::Other` | 1 | 2 | 0 | 0 | 1 | 1 | 5 | 0 | 10 |
...
265 mentions in seven files. The rows are `Program`'s `Vec` fields, read out of
