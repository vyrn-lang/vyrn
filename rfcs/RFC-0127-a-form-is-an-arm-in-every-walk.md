...
1,283 mentions in eight files for 38 forms. The table is generated by
...
| `Stmt::Assign` | 2 | 6 | 2 | 1 | 7 | 3 | 2 | 0 | 23 |
| `Stmt::SetField` | 4 | 6 | 2 | 1 | 6 | 3 | 3 | 0 | 25 |
| `Stmt::IndexSet` | 4 | 6 | 2 | 1 | 6 | 3 | 2 | 0 | 24 |
| `Stmt::Return` | 1 | 12 | 2 | 1 | 8 | 5 | 3 | 1 | 33 |
| `Stmt::Break` | 2 | 6 | 1 | 1 | 8 | 3 | 1 | 0 | 22 |
| `Stmt::Continue` | 1 | 6 | 1 | 1 | 8 | 3 | 1 | 0 | 21 |
| `Stmt::If` | 2 | 9 | 4 | 1 | 8 | 3 | 1 | 0 | 28 |
| `Stmt::IfLet` | 2 | 7 | 4 | 1 | 8 | 3 | 2 | 1 | 28 |
| `Stmt::While` | 2 | 9 | 4 | 1 | 7 | 3 | 1 | 0 | 27 |
| `Stmt::ForIn` | 1 | 10 | 4 | 1 | 7 | 3 | 2 | 1 | 29 |
| `Stmt::Drop` | 1 | 7 | 2 | 1 | 6 | 3 | 2 | 0 | 22 |
| `Stmt::Expr` | 2 | 6 | 2 | 1 | 7 | 3 | 3 | 0 | 24 |
| `Stmt::Region` | 1 | 9 | 3 | 1 | 8 | 3 | 1 | 0 | 26 |
| `Expr::Int` | 4 | 9 | 7 | 1 | 8 | 2 | 3 | 1 | 35 |
| `Expr::Byte` | 2 | 7 | 5 | 1 | 8 | 2 | 3 | 1 | 29 |
| `Expr::Float` | 2 | 7 | 6 | 1 | 8 | 2 | 2 | 1 | 29 |
| `Expr::Bool` | 4 | 5 | 6 | 1 | 8 | 2 | 2 | 1 | 29 |
| `Expr::Str` | 7 | 6 | 6 | 2 | 8 | 2 | 7 | 2 | 40 |
| `Expr::Var` | 25 | 23 | 19 | 1 | 25 | 5 | 30 | 0 | 128 |
| `Expr::Unary` | 4 | 8 | 6 | 1 | 7 | 3 | 1 | 1 | 31 |
| `Expr::Binary` | 3 | 7 | 8 | 2 | 8 | 4 | 1 | 0 | 33 |
| `Expr::Call` | 22 | 13 | 25 | 2 | 26 | 4 | 11 | 0 | 103 |
| `Expr::Match` | 8 | 9 | 13 | 2 | 9 | 3 | 3 | 0 | 47 |
| `Expr::IfExpr` | 1 | 8 | 12 | 1 | 8 | 3 | 1 | 0 | 34 |
| `Expr::Try` | 1 | 7 | 6 | 1 | 6 | 3 | 3 | 0 | 27 |
| `Expr::StructLit` | 2 | 8 | 8 | 1 | 9 | 3 | 2 | 0 | 33 |
| `Expr::Field` | 6 | 7 | 15 | 1 | 14 | 3 | 2 | 0 | 48 |
| `Expr::TryConstruct` | 1 | 7 | 5 | 1 | 5 | 3 | 3 | 0 | 25 |
| `Expr::ArrayLit` | 5 | 7 | 6 | 1 | 9 | 4 | 3 | 1 | 36 |
| `Expr::MapLit` | 3 | 5 | 6 | 1 | 6 | 3 | 2 | 0 | 26 |
| `Expr::Spawn` | 1 | 7 | 5 | 1 | 7 | 3 | 4 | 0 | 28 |
| `Expr::Lambda` | 1 | 10 | 6 | 2 | 9 | 2 | 8 | 1 | 39 |
| `Expr::Consume` | 1 | 5 | 10 | 1 | 11 | 2 | 5 | 0 | 35 |
...
`Stmt::Continue` costs 21 mentions. A `continue` has no operand, no type, no
value, no ownership effect and no diagnostic of its own; the checker asks
whether a loop encloses it and every other pass steps over it. So **21 is the
price of existing**, and the rows above it pay 21 plus what they decide:

| form | all eight | above the floor | what the excess buys |
|---|---|---|---|
| `Stmt::Continue` | 21 | 0 | the floor |
| `Stmt::Break` | 22 | 1 | one more arm, in `own` |
| `Stmt::Drop` | 22 | 1 | RFC-0114's explicit reclaim |
| `Stmt::Let` | 40 | 19 | a binder, a type, a placement, a copy rule |
| `Stmt::Return` | 33 | 12 | the release of every live binding on the way out |
...
26 apart: two mentions are the parser building and the checker's own rule; the
