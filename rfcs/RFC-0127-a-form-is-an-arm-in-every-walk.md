...
1,172 mentions in eight files for 38 forms. The table is generated by
...
|---|---|---|---|---|---|---|---|---|---|
| `Stmt::Let` | 8 | 8 | 3 | 2 | 9 | 3 | 4 | 1 | 38 |
| `Stmt::Assign` | 2 | 5 | 2 | 1 | 7 | 2 | 2 | 0 | 21 |
| `Stmt::SetField` | 4 | 5 | 2 | 1 | 6 | 2 | 3 | 0 | 23 |
| `Stmt::IndexSet` | 4 | 5 | 2 | 1 | 6 | 2 | 2 | 0 | 22 |
| `Stmt::Return` | 1 | 9 | 2 | 1 | 8 | 4 | 3 | 1 | 29 |
| `Stmt::Break` | 2 | 4 | 1 | 1 | 8 | 2 | 1 | 0 | 19 |
| `Stmt::Continue` | 1 | 4 | 1 | 1 | 8 | 2 | 1 | 0 | 18 |
| `Stmt::If` | 2 | 7 | 4 | 1 | 8 | 2 | 1 | 0 | 25 |
| `Stmt::IfLet` | 2 | 5 | 4 | 1 | 8 | 3 | 2 | 1 | 26 |
| `Stmt::While` | 2 | 7 | 4 | 1 | 7 | 2 | 1 | 0 | 24 |
| `Stmt::ForIn` | 1 | 8 | 4 | 1 | 7 | 3 | 2 | 1 | 27 |
| `Stmt::Drop` | 1 | 6 | 2 | 1 | 6 | 2 | 2 | 0 | 20 |
| `Stmt::Expr` | 2 | 4 | 2 | 1 | 7 | 2 | 3 | 0 | 21 |
| `Stmt::Region` | 1 | 7 | 3 | 1 | 8 | 2 | 1 | 0 | 23 |
...
| `Expr::Unary` | 4 | 6 | 4 | 1 | 7 | 2 | 1 | 1 | 26 |
| `Expr::Binary` | 3 | 5 | 6 | 2 | 8 | 3 | 1 | 0 | 28 |
| `Expr::Call` | 22 | 13 | 23 | 2 | 26 | 3 | 11 | 0 | 100 |
| `Expr::Match` | 8 | 7 | 11 | 2 | 9 | 2 | 3 | 0 | 42 |
| `Expr::IfExpr` | 1 | 6 | 10 | 1 | 8 | 2 | 1 | 0 | 29 |
| `Expr::Try` | 1 | 5 | 4 | 1 | 6 | 2 | 3 | 0 | 22 |
| `Expr::StructLit` | 2 | 6 | 6 | 1 | 9 | 2 | 2 | 0 | 28 |
| `Expr::Field` | 6 | 5 | 13 | 1 | 14 | 2 | 2 | 0 | 43 |
| `Expr::TryConstruct` | 1 | 6 | 3 | 1 | 5 | 2 | 3 | 0 | 21 |
| `Expr::ArrayLit` | 5 | 5 | 4 | 1 | 9 | 3 | 3 | 1 | 31 |
| `Expr::MapLit` | 3 | 4 | 4 | 1 | 6 | 2 | 2 | 0 | 22 |
| `Expr::Spawn` | 1 | 7 | 3 | 1 | 7 | 2 | 4 | 0 | 25 |
| `Expr::Lambda` | 1 | 9 | 7 | 2 | 9 | 2 | 8 | 1 | 39 |
...
`Stmt::Continue` costs 18 mentions. A `continue` has no operand, no type, no
value, no ownership effect and no diagnostic of its own; the checker asks
whether a loop encloses it and every other pass steps over it. So **18 is the
price of existing**, and the rows above it pay 18 plus what they decide:

| form | all eight | above the floor | what the excess buys |
|---|---|---|---|
| `Stmt::Continue` | 18 | 0 | the floor |
| `Stmt::Break` | 19 | 1 | one more arm, in `own` |
| `Stmt::Drop` | 20 | 2 | RFC-0114's explicit reclaim, and the capture rule |
| `Stmt::Let` | 38 | 20 | a binder, a type, a placement, a copy rule |
| `Stmt::Return` | 29 | 11 | the release of every live binding on the way out |

An expression's floor is 21 (`Expr::TryConstruct`), and it is higher for the
...
23 apart: two mentions are the parser building and the checker's own rule; the
