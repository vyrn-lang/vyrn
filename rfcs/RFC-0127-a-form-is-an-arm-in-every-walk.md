...
1,119 mentions in eight files for 38 forms. The table is generated by
...
|---|---|---|---|---|---|---|---|---|---|
| `Stmt::Let` | 8 | 7 | 3 | 2 | 9 | 2 | 4 | 1 | 36 |
| `Stmt::Assign` | 2 | 5 | 2 | 1 | 7 | 1 | 2 | 0 | 20 |
| `Stmt::SetField` | 4 | 5 | 2 | 1 | 6 | 1 | 3 | 0 | 22 |
| `Stmt::IndexSet` | 4 | 5 | 2 | 1 | 6 | 1 | 2 | 0 | 21 |
| `Stmt::Return` | 1 | 7 | 2 | 1 | 8 | 2 | 3 | 1 | 25 |
| `Stmt::Break` | 2 | 3 | 1 | 1 | 8 | 1 | 1 | 0 | 17 |
| `Stmt::Continue` | 1 | 3 | 1 | 1 | 8 | 1 | 1 | 0 | 16 |
| `Stmt::If` | 2 | 6 | 4 | 1 | 8 | 1 | 1 | 0 | 23 |
| `Stmt::IfLet` | 2 | 4 | 4 | 1 | 8 | 2 | 2 | 1 | 24 |
| `Stmt::While` | 2 | 6 | 4 | 1 | 7 | 1 | 1 | 0 | 22 |
| `Stmt::ForIn` | 1 | 7 | 4 | 1 | 7 | 2 | 2 | 1 | 25 |
| `Stmt::Drop` | 1 | 6 | 2 | 1 | 6 | 1 | 2 | 0 | 19 |
| `Stmt::Expr` | 2 | 3 | 2 | 1 | 7 | 1 | 3 | 0 | 19 |
| `Stmt::Region` | 1 | 6 | 3 | 1 | 8 | 1 | 1 | 0 | 21 |
| `Expr::Int` | 4 | 7 | 6 | 1 | 8 | 1 | 3 | 1 | 31 |
| `Expr::Byte` | 2 | 5 | 4 | 1 | 8 | 1 | 3 | 1 | 25 |
| `Expr::Float` | 2 | 5 | 5 | 1 | 8 | 1 | 2 | 1 | 25 |
| `Expr::Bool` | 4 | 3 | 5 | 1 | 8 | 1 | 2 | 1 | 25 |
| `Expr::Str` | 7 | 4 | 5 | 2 | 8 | 1 | 7 | 2 | 36 |
| `Expr::Var` | 25 | 22 | 19 | 1 | 25 | 4 | 30 | 0 | 126 |
| `Expr::Unary` | 4 | 5 | 4 | 1 | 7 | 1 | 1 | 1 | 24 |
| `Expr::Binary` | 3 | 4 | 6 | 2 | 8 | 2 | 1 | 0 | 26 |
| `Expr::Call` | 22 | 13 | 23 | 2 | 26 | 3 | 11 | 0 | 100 |
| `Expr::Match` | 8 | 6 | 11 | 2 | 9 | 1 | 3 | 0 | 40 |
| `Expr::IfExpr` | 1 | 5 | 10 | 1 | 8 | 1 | 1 | 0 | 27 |
| `Expr::Try` | 1 | 4 | 4 | 1 | 6 | 1 | 3 | 0 | 20 |
| `Expr::StructLit` | 2 | 5 | 6 | 1 | 9 | 1 | 2 | 0 | 26 |
| `Expr::Field` | 6 | 4 | 13 | 1 | 14 | 1 | 2 | 0 | 41 |
| `Expr::TryConstruct` | 1 | 5 | 3 | 1 | 5 | 1 | 3 | 0 | 19 |
| `Expr::ArrayLit` | 5 | 4 | 4 | 1 | 9 | 2 | 3 | 1 | 29 |
| `Expr::MapLit` | 3 | 3 | 4 | 1 | 6 | 2 | 2 | 0 | 21 |
| `Expr::Spawn` | 1 | 6 | 3 | 1 | 7 | 1 | 4 | 0 | 23 |
| `Expr::Lambda` | 1 | 8 | 7 | 2 | 9 | 3 | 8 | 1 | 39 |
| `Expr::Consume` | 1 | 3 | 8 | 1 | 11 | 1 | 5 | 0 | 30 |
...
| `Stmt::Drop` | 19 | 3 | RFC-0114's explicit reclaim, the capture rule, the purity walk |
| `Stmt::Let` | 36 | 20 | a binder, a type, a placement, a copy rule |
| `Stmt::Return` | 25 | 9 | the release of every live binding on the way out |

An expression's floor is 19 (`Expr::TryConstruct`), and it is higher for the
...
21 apart: two mentions are the parser building and the checker's own rule; the
