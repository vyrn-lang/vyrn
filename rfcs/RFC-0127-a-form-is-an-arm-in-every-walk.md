...
1,386 mentions in eight files for 38 forms. The table is generated by
...
| `Stmt::If` | 2 | 8 | 4 | 3 | 8 | 3 | 2 | 1 | 31 |
| `Stmt::IfLet` | 2 | 7 | 4 | 3 | 8 | 3 | 3 | 1 | 31 |
| `Stmt::While` | 2 | 8 | 4 | 3 | 7 | 3 | 2 | 1 | 30 |
| `Stmt::ForIn` | 1 | 9 | 4 | 3 | 7 | 3 | 3 | 1 | 31 |
| `Stmt::Drop` | 1 | 6 | 2 | 3 | 6 | 3 | 3 | 1 | 25 |
| `Stmt::Expr` | 2 | 6 | 2 | 3 | 7 | 3 | 4 | 1 | 28 |
| `Stmt::Region` | 1 | 8 | 3 | 3 | 8 | 3 | 2 | 1 | 29 |
| `Expr::Int` | 4 | 9 | 7 | 2 | 8 | 2 | 4 | 2 | 38 |
| `Expr::Byte` | 2 | 7 | 5 | 2 | 8 | 2 | 4 | 2 | 32 |
| `Expr::Float` | 2 | 7 | 6 | 2 | 8 | 2 | 3 | 2 | 32 |
| `Expr::Bool` | 4 | 5 | 6 | 2 | 8 | 2 | 3 | 2 | 32 |
| `Expr::Str` | 7 | 6 | 6 | 3 | 8 | 2 | 8 | 3 | 43 |
| `Expr::Var` | 25 | 23 | 19 | 2 | 25 | 5 | 31 | 1 | 131 |
...
| `Expr::Field` | 6 | 7 | 15 | 2 | 14 | 3 | 3 | 1 | 51 |
...
census ran from 7 mentions to 244, a factor of 35. This one runs from 12 to 131,
and once `Expr::Var` and `Expr::Call` are set aside — every walk names those two
for reasons of its own — from 12 to 51, with 33 of the 38 rows between 25 and
51. A type constructor's cost tells you something about the constructor. A
