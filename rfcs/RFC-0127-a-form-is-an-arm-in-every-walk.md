...
recognise. 84 rows, one verdict each.
...
837 mentions in eight files for 37 forms. The table is generated by
...
|---|---|---|---|---|---|---|---|---|---|
| `Stmt::Let` | 7 | 4 | 1 | 0 | 7 | 2 | 10 | 0 | 31 |
| `Stmt::Assign` | 3 | 3 | 1 | 0 | 5 | 1 | 5 | 0 | 18 |
| `Stmt::SetField` | 4 | 3 | 1 | 0 | 4 | 1 | 3 | 0 | 16 |
| `Stmt::IndexSet` | 3 | 3 | 2 | 0 | 4 | 1 | 2 | 0 | 15 |
| `Stmt::Return` | 1 | 5 | 1 | 0 | 6 | 2 | 6 | 1 | 22 |
| `Stmt::Break` | 2 | 1 | 1 | 0 | 6 | 1 | 4 | 0 | 15 |
| `Stmt::Continue` | 1 | 1 | 1 | 0 | 6 | 1 | 4 | 0 | 14 |
| `Stmt::If` | 2 | 3 | 1 | 0 | 6 | 1 | 4 | 0 | 17 |
| `Stmt::IfLet` | 2 | 2 | 1 | 0 | 6 | 2 | 5 | 0 | 18 |
| `Stmt::While` | 2 | 3 | 1 | 0 | 5 | 1 | 4 | 0 | 16 |
| `Stmt::ForIn` | 1 | 4 | 1 | 0 | 5 | 2 | 5 | 0 | 18 |
| `Stmt::Drop` | 1 | 3 | 1 | 0 | 4 | 1 | 4 | 0 | 14 |
| `Stmt::Expr` | 2 | 1 | 1 | 0 | 5 | 1 | 6 | 0 | 16 |
| `Stmt::Region` | 1 | 3 | 1 | 0 | 6 | 1 | 1 | 0 | 13 |
| `Expr::Int` | 4 | 6 | 1 | 0 | 7 | 1 | 5 | 1 | 25 |
| `Expr::Byte` | 2 | 3 | 1 | 0 | 7 | 1 | 5 | 1 | 20 |
| `Expr::Float` | 2 | 4 | 1 | 0 | 7 | 1 | 4 | 1 | 20 |
| `Expr::Bool` | 4 | 2 | 1 | 0 | 7 | 1 | 4 | 1 | 20 |
| `Expr::Str` | 7 | 3 | 1 | 0 | 7 | 1 | 9 | 2 | 30 |
| `Expr::Var` | 25 | 17 | 4 | 0 | 26 | 4 | 31 | 0 | 107 |
| `Expr::Unary` | 4 | 3 | 1 | 0 | 5 | 1 | 3 | 1 | 18 |
| `Expr::Binary` | 3 | 2 | 1 | 1 | 6 | 2 | 3 | 0 | 18 |
| `Expr::Call` | 23 | 12 | 8 | 1 | 27 | 3 | 10 | 0 | 84 |
| `Expr::Match` | 8 | 5 | 4 | 0 | 7 | 1 | 3 | 0 | 28 |
| `Expr::IfExpr` | 1 | 3 | 2 | 0 | 6 | 1 | 1 | 0 | 14 |
| `Expr::Try` | 1 | 2 | 1 | 0 | 4 | 1 | 3 | 0 | 12 |
| `Expr::StructLit` | 2 | 3 | 1 | 0 | 7 | 1 | 3 | 0 | 17 |
| `Expr::Field` | 7 | 2 | 4 | 0 | 12 | 1 | 2 | 0 | 28 |
| `Expr::TryConstruct` | 1 | 3 | 1 | 0 | 3 | 1 | 3 | 0 | 12 |
| `Expr::ArrayLit` | 5 | 2 | 1 | 0 | 6 | 2 | 3 | 1 | 20 |
| `Expr::MapLit` | 3 | 2 | 1 | 0 | 4 | 2 | 2 | 0 | 14 |
| `Expr::Lambda` | 1 | 7 | 3 | 0 | 9 | 3 | 8 | 0 | 31 |
| `Expr::Consume` | 1 | 2 | 2 | 0 | 9 | 1 | 4 | 0 | 19 |
| `Pattern::Variant` | 11 | 4 | 1 | 0 | 2 | 0 | 5 | 0 | 23 |
| `Pattern::Success` | 1 | 4 | 2 | 0 | 3 | 0 | 6 | 0 | 16 |
| `Pattern::Failure` | 1 | 3 | 1 | 0 | 2 | 0 | 3 | 0 | 10 |
| `Pattern::Other` | 1 | 2 | 0 | 0 | 1 | 0 | 4 | 0 | 8 |
...
for reasons of its own — from 13 to 49, with 33 of the 38 rows between 22 and
49. A type constructor's cost tells you something about the constructor. A
form's cost mostly does not.

### 3.1.1 The floor, and what is above it

`Stmt::Continue` costs 15 mentions. A `continue` has no operand, no type, no
value, no ownership effect and no diagnostic of its own; the checker asks
whether a loop encloses it and every other pass steps over it. So **15 is the
price of existing**, and the rows above it pay 15 plus what they decide:

| form | all eight | above the floor | what the excess buys |
|---|---|---|---|
| `Stmt::Continue` | 15 | 0 | the floor |
| `Stmt::Break` | 16 | 1 | one more arm, in `own` |
| `Stmt::Drop` | 18 | 3 | RFC-0114's explicit reclaim, the capture rule, the purity walk |
| `Stmt::Let` | 34 | 19 | a binder, a type, a placement, a copy rule |
| `Stmt::Return` | 24 | 9 | the release of every live binding on the way out |

An expression's floor is 16 (`Expr::TryConstruct`), and it is higher for the
same reason a `Stmt` floor exists: an expression is walked by more collectors
than a statement is. A pattern is walked by fewer than either, and the three
unspellable ones are the cheapest rows in the table: `Pattern::Other` at 10,
`Pattern::Failure` at 12, `Pattern::Success` at 18. They fell by three each when
RFC-0125 §3 M6's binder slice made `ast::Pattern::bindings` the one statement of
what a pattern binds, so the checker, the move check and the editor each stopped
matching on all four.

**Where the floor comes from.** It is not the deciders. Taking `Stmt::Region`'s
20 apart: two mentions are the parser building and the checker's own rule; the
rest are exhaustive walks that do nothing with a region except recurse into its
block — `scan_append_block`, and a `line()` match in each of four files. It was 33 over six such walks: `collect_regex_block`,
...
### 3.4 The 23 keywords and the 13 contextual words

122 mentions in three files for the keywords. The spellings and the tokens are
read out of the lexer's `keywords!` table, which is the same anchor
`editor/vscode/test/grammar.test.mjs` reads; this census is that table's third
reader.

| keyword | token | lexer | parser | fmt | all three |
|---|---|---|---|---|
| `fn` | `Tok::Fn` | 1 | 20 | 2 | 23 |
| `let` | `Tok::Let` | 1 | 14 | 0 | 15 |
| `mut` | `Tok::Mut` | 1 | 5 | 0 | 6 |
| `if` | `Tok::If` | 1 | 4 | 0 | 5 |
| `else` | `Tok::Else` | 1 | 2 | 0 | 3 |
| `while` | `Tok::While` | 1 | 2 | 0 | 3 |
| `for` | `Tok::For` | 1 | 3 | 0 | 4 |
| `in` | `Tok::In` | 1 | 1 | 0 | 2 |
| `drop` | `Tok::Drop` | 1 | 2 | 0 | 3 |
| `protocol` | `Tok::Protocol` | 1 | 4 | 0 | 5 |
| `import` | `Tok::Import` | 1 | 3 | 0 | 4 |
| `export` | `Tok::Export` | 1 | 2 | 0 | 3 |
| `impl` | `Tok::Impl` | 1 | 3 | 1 | 5 |
| `self` | `Tok::Vself` | 1 | 8 | 1 | 10 |
| `return` | `Tok::Return` | 1 | 2 | 0 | 3 |
| `true` | `Tok::True` | 1 | 1 | 1 | 3 |
| `false` | `Tok::False` | 1 | 1 | 1 | 3 |
| `type` | `Tok::Type` | 1 | 7 | 0 | 8 |
| `where` | `Tok::Where` | 1 | 2 | 0 | 3 |
| `match` | `Tok::Match` | 1 | 1 | 0 | 2 |
| `region` | `Tok::Region` | 1 | 2 | 0 | 3 |
| `break` | `Tok::Break` | 1 | 2 | 0 | 3 |
| `continue` | `Tok::Continue` | 1 | 2 | 0 | 3 |

**Every keyword costs the lexer exactly 1**, without exception: its row in the
`keywords!` table, which expands into `keyword_or_ident` and into the reverse
lookup `token_name_and_text` answers `lex()` with (RFC-0054). It was 3, then 2.
The third was `lex`'s own copy of the spelling table, which went when RFC-0125
§3 M6 folded the two lexical scans into one; the second was
`token_name_and_text`'s own row, which the same milestone folded after
`punctuation!` had shown the shape. The two can no longer disagree, because
...
Of the 46 rows: `desugar` 0, `decide` 11, `stays` 35.
...
| 5.3 | `TryConstruct` into `Call` | 0 | no | yes | no | not taken |
...
### 5.3 `TryConstruct` into `Call` — 0 saved, a rename

`Expr::TryConstruct { name, args, line }` has `Expr::Call`'s exact shape.
Folding it into `Call` with a flag renames 36 sites and deletes no rule: every arm that reads the flag is the arm
that read the constructor. RFC-0126 §5.4 refused `Float`/`Float32` for this
reason and `IntN` kept `Int` separate for it.

And it costs a diagnostic. `Age?(n)` reports a validated type's own refusal,
and the message is selected today by the form the parser built. **Not taken.**
