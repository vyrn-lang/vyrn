...
1,192 mentions in eight files for 38 forms. The table is generated by
...
| `Expr::Unary` | 4 | 7 | 4 | 1 | 7 | 2 | 1 | 1 | 27 |
| `Expr::Binary` | 3 | 6 | 6 | 2 | 8 | 3 | 1 | 0 | 29 |
| `Expr::Call` | 22 | 13 | 23 | 2 | 26 | 3 | 11 | 0 | 100 |
| `Expr::Match` | 8 | 8 | 11 | 2 | 9 | 2 | 3 | 0 | 43 |
| `Expr::IfExpr` | 1 | 7 | 10 | 1 | 8 | 2 | 1 | 0 | 30 |
| `Expr::Try` | 1 | 6 | 4 | 1 | 6 | 2 | 3 | 0 | 23 |
| `Expr::StructLit` | 2 | 7 | 6 | 1 | 9 | 2 | 2 | 0 | 29 |
| `Expr::Field` | 6 | 6 | 13 | 1 | 14 | 2 | 2 | 0 | 44 |
| `Expr::TryConstruct` | 1 | 7 | 3 | 1 | 5 | 2 | 3 | 0 | 22 |
| `Expr::ArrayLit` | 5 | 6 | 4 | 1 | 9 | 3 | 3 | 1 | 32 |
...
An expression's floor is 22 (`Expr::TryConstruct`), and it is higher for the
