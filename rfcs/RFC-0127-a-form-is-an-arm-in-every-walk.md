...
955 mentions in eight files for 38 forms. The table is generated by
...
| `Expr::Var` | 26 | 22 | 13 | 0 | 26 | 4 | 32 | 0 | 123 |
| `Expr::Unary` | 4 | 3 | 2 | 0 | 6 | 1 | 3 | 1 | 20 |
| `Expr::Binary` | 3 | 2 | 2 | 1 | 7 | 2 | 3 | 0 | 20 |
| `Expr::Call` | 23 | 12 | 9 | 1 | 26 | 3 | 10 | 0 | 84 |
| `Expr::Match` | 8 | 5 | 6 | 0 | 8 | 1 | 3 | 0 | 31 |
| `Expr::IfExpr` | 1 | 3 | 3 | 0 | 7 | 1 | 1 | 0 | 16 |
| `Expr::Try` | 1 | 2 | 2 | 0 | 5 | 1 | 3 | 0 | 14 |
| `Expr::StructLit` | 2 | 3 | 2 | 0 | 8 | 1 | 2 | 0 | 18 |
| `Expr::Field` | 7 | 2 | 10 | 0 | 13 | 1 | 2 | 0 | 35 |
| `Expr::TryConstruct` | 1 | 3 | 2 | 0 | 4 | 1 | 3 | 0 | 14 |
| `Expr::ArrayLit` | 5 | 2 | 2 | 0 | 7 | 2 | 3 | 1 | 22 |
| `Expr::MapLit` | 3 | 2 | 2 | 0 | 5 | 2 | 2 | 0 | 16 |
| `Expr::Spawn` | 1 | 6 | 2 | 0 | 7 | 1 | 4 | 0 | 21 |
| `Expr::Lambda` | 1 | 7 | 4 | 0 | 10 | 3 | 8 | 1 | 34 |
| `Expr::Consume` | 1 | 2 | 4 | 0 | 10 | 1 | 4 | 0 | 22 |
...
`Stmt::Region` sits on the floor too, at 14. An expression's floor is the same
number, and two rows hold it: `Expr::Try` and `Expr::TryConstruct`. A pattern is
walked by fewer passes than either, and `Pattern::Other` at 13 is the one row
under the statement floor.
