...
1,341 mentions in eight files for 38 forms. The table is generated by
...
| `Stmt::If` | 2 | 8 | 4 | 1 | 8 | 3 | 2 | 1 | 29 |
| `Stmt::IfLet` | 2 | 7 | 4 | 1 | 8 | 3 | 3 | 1 | 29 |
| `Stmt::While` | 2 | 8 | 4 | 1 | 7 | 3 | 2 | 1 | 28 |
| `Stmt::ForIn` | 1 | 9 | 4 | 1 | 7 | 3 | 3 | 1 | 29 |
| `Stmt::Drop` | 1 | 6 | 2 | 1 | 6 | 3 | 3 | 1 | 23 |
| `Stmt::Expr` | 2 | 6 | 2 | 1 | 7 | 3 | 4 | 1 | 26 |
| `Stmt::Region` | 1 | 8 | 3 | 1 | 8 | 3 | 2 | 1 | 27 |
...
| `Expr::Call` | 22 | 13 | 25 | 2 | 27 | 4 | 11 | 1 | 105 |
...
| `Stmt::Drop` | 25 | 0 | the floor, since the release slice took the spawn rule's `drop` search |
