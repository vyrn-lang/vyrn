...
1,262 mentions in eight files for 38 forms. The table is generated by
...
|---|---|---|---|---|---|---|---|---|---|
| `Stmt::Let` | 8 | 10 | 3 | 0 | 9 | 3 | 5 | 1 | 39 |
| `Stmt::Assign` | 2 | 6 | 2 | 0 | 7 | 3 | 3 | 1 | 24 |
| `Stmt::SetField` | 4 | 6 | 2 | 0 | 6 | 3 | 4 | 1 | 26 |
| `Stmt::IndexSet` | 4 | 6 | 2 | 0 | 6 | 3 | 3 | 1 | 25 |
| `Stmt::Return` | 1 | 12 | 2 | 0 | 8 | 5 | 4 | 3 | 35 |
| `Stmt::Break` | 2 | 6 | 1 | 0 | 8 | 3 | 2 | 1 | 23 |
| `Stmt::Continue` | 1 | 6 | 1 | 0 | 8 | 3 | 2 | 1 | 22 |
| `Stmt::If` | 2 | 9 | 4 | 0 | 8 | 3 | 2 | 1 | 29 |
| `Stmt::IfLet` | 2 | 7 | 4 | 0 | 8 | 3 | 3 | 1 | 28 |
| `Stmt::While` | 2 | 9 | 4 | 0 | 7 | 3 | 2 | 1 | 28 |
| `Stmt::ForIn` | 1 | 10 | 4 | 0 | 7 | 3 | 3 | 1 | 29 |
| `Stmt::Drop` | 1 | 7 | 2 | 0 | 6 | 3 | 3 | 1 | 23 |
| `Stmt::Expr` | 2 | 6 | 2 | 0 | 7 | 3 | 4 | 1 | 25 |
| `Stmt::Region` | 1 | 9 | 3 | 0 | 8 | 3 | 2 | 1 | 27 |
| `Expr::Int` | 4 | 9 | 6 | 0 | 8 | 2 | 4 | 2 | 35 |
| `Expr::Byte` | 2 | 7 | 4 | 0 | 8 | 2 | 4 | 2 | 29 |
| `Expr::Float` | 2 | 7 | 5 | 0 | 8 | 2 | 3 | 2 | 29 |
| `Expr::Bool` | 4 | 5 | 5 | 0 | 8 | 2 | 3 | 2 | 29 |
| `Expr::Str` | 7 | 6 | 5 | 0 | 8 | 2 | 8 | 3 | 39 |
| `Expr::Var` | 25 | 23 | 15 | 0 | 25 | 5 | 31 | 1 | 125 |
| `Expr::Unary` | 4 | 8 | 5 | 0 | 7 | 3 | 2 | 2 | 31 |
| `Expr::Binary` | 3 | 7 | 5 | 1 | 8 | 4 | 2 | 1 | 31 |
| `Expr::Call` | 22 | 13 | 14 | 1 | 26 | 4 | 12 | 1 | 93 |
| `Expr::Match` | 8 | 9 | 9 | 0 | 9 | 3 | 4 | 1 | 43 |
| `Expr::IfExpr` | 1 | 8 | 7 | 0 | 8 | 3 | 2 | 1 | 30 |
| `Expr::Try` | 1 | 7 | 4 | 0 | 6 | 3 | 4 | 1 | 26 |
| `Expr::StructLit` | 2 | 8 | 6 | 0 | 9 | 3 | 3 | 1 | 32 |
| `Expr::Field` | 6 | 7 | 13 | 0 | 14 | 3 | 3 | 1 | 47 |
| `Expr::TryConstruct` | 1 | 7 | 4 | 0 | 5 | 3 | 4 | 1 | 25 |
| `Expr::ArrayLit` | 5 | 7 | 5 | 0 | 9 | 4 | 4 | 2 | 36 |
| `Expr::MapLit` | 3 | 5 | 5 | 0 | 6 | 3 | 3 | 1 | 26 |
| `Expr::Spawn` | 1 | 7 | 4 | 0 | 7 | 3 | 5 | 1 | 28 |
| `Expr::Lambda` | 1 | 10 | 5 | 0 | 9 | 2 | 8 | 1 | 36 |
| `Expr::Consume` | 1 | 5 | 7 | 0 | 11 | 2 | 6 | 1 | 33 |
...
census ran from 7 mentions to 244, a factor of 35. This one runs from 13 to 130,
and once `Expr::Var` and `Expr::Call` are set aside — every walk names those two
for reasons of its own — from 13 to 50, with 33 of the 38 rows between 23 and
50. A type constructor's cost tells you something about the constructor. A
...
| `Stmt::Drop` | 24 | 1 | RFC-0114's explicit reclaim |
| `Stmt::Let` | 41 | 18 | a binder, a type, a placement, a copy rule |
| `Stmt::Return` | 36 | 13 | the release of every live binding on the way out |

An expression's floor is 27 (`Expr::TryConstruct`), and it is higher for the
...
28 apart: two mentions are the parser building and the checker's own rule; the
