...
1,432 mentions in eight files for 38 forms. The table is generated by
...
|---|---|---|---|---|---|---|---|---|---|
| `Stmt::Let` | 8 | 10 | 5 | 4 | 6 | 3 | 5 | 1 | 42 |
| `Stmt::Assign` | 2 | 6 | 4 | 3 | 5 | 3 | 3 | 1 | 27 |
| `Stmt::SetField` | 4 | 6 | 3 | 3 | 5 | 3 | 4 | 1 | 29 |
| `Stmt::IndexSet` | 4 | 6 | 3 | 3 | 5 | 3 | 3 | 1 | 28 |
| `Stmt::Return` | 1 | 12 | 5 | 3 | 5 | 5 | 4 | 3 | 38 |
| `Stmt::Break` | 2 | 6 | 4 | 3 | 5 | 3 | 2 | 1 | 26 |
| `Stmt::Continue` | 1 | 6 | 4 | 3 | 5 | 3 | 2 | 1 | 25 |
| `Stmt::If` | 2 | 9 | 7 | 3 | 5 | 3 | 2 | 1 | 32 |
| `Stmt::IfLet` | 2 | 7 | 7 | 3 | 5 | 3 | 3 | 1 | 31 |
| `Stmt::While` | 2 | 9 | 6 | 3 | 5 | 3 | 2 | 1 | 31 |
| `Stmt::ForIn` | 1 | 10 | 6 | 3 | 5 | 3 | 3 | 1 | 32 |
| `Stmt::Drop` | 1 | 7 | 3 | 3 | 5 | 3 | 3 | 1 | 26 |
| `Stmt::Expr` | 2 | 6 | 4 | 3 | 5 | 3 | 4 | 1 | 28 |
| `Stmt::Region` | 1 | 9 | 6 | 3 | 5 | 3 | 2 | 1 | 30 |
| `Expr::Int` | 4 | 9 | 8 | 2 | 8 | 2 | 4 | 2 | 39 |
| `Expr::Byte` | 2 | 7 | 5 | 2 | 8 | 2 | 4 | 2 | 32 |
| `Expr::Float` | 2 | 7 | 7 | 2 | 8 | 2 | 3 | 2 | 33 |
| `Expr::Bool` | 4 | 5 | 7 | 2 | 8 | 2 | 3 | 2 | 33 |
| `Expr::Str` | 7 | 6 | 10 | 4 | 8 | 2 | 8 | 3 | 48 |
| `Expr::Var` | 25 | 23 | 23 | 3 | 24 | 5 | 31 | 1 | 135 |
| `Expr::Unary` | 4 | 8 | 6 | 2 | 7 | 3 | 2 | 2 | 34 |
| `Expr::Binary` | 3 | 7 | 13 | 3 | 8 | 4 | 2 | 1 | 41 |
| `Expr::Call` | 22 | 13 | 40 | 4 | 24 | 4 | 11 | 1 | 119 |
| `Expr::Match` | 7 | 10 | 16 | 4 | 7 | 3 | 4 | 1 | 52 |
| `Expr::IfExpr` | 1 | 8 | 14 | 2 | 6 | 3 | 2 | 1 | 37 |
| `Expr::Try` | 1 | 7 | 6 | 2 | 6 | 3 | 4 | 1 | 30 |
| `Expr::StructLit` | 2 | 8 | 9 | 2 | 9 | 3 | 3 | 1 | 37 |
| `Expr::Field` | 6 | 7 | 17 | 3 | 14 | 3 | 3 | 1 | 54 |
| `Expr::TryConstruct` | 1 | 7 | 5 | 2 | 5 | 3 | 4 | 1 | 28 |
| `Expr::ArrayLit` | 5 | 7 | 10 | 2 | 9 | 4 | 4 | 2 | 43 |
| `Expr::MapLit` | 3 | 5 | 6 | 2 | 6 | 3 | 3 | 1 | 29 |
| `Expr::Spawn` | 1 | 7 | 6 | 2 | 6 | 3 | 5 | 1 | 31 |
| `Expr::Lambda` | 1 | 10 | 6 | 3 | 9 | 2 | 8 | 1 | 40 |
| `Expr::Consume` | 1 | 5 | 10 | 2 | 11 | 2 | 6 | 1 | 38 |
| `Pattern::Variant` | 11 | 5 | 3 | 0 | 1 | 1 | 6 | 1 | 28 |
| `Pattern::Success` | 1 | 5 | 4 | 0 | 3 | 1 | 5 | 1 | 20 |
| `Pattern::Failure` | 1 | 4 | 2 | 0 | 2 | 1 | 3 | 1 | 14 |
| `Pattern::Other` | 1 | 3 | 1 | 0 | 1 | 1 | 4 | 1 | 12 |
|---|---|---|---|---|---|---|---|---|
| `Stmt::Let` | 8 | 10 | 5 | 4 | 6 | 5 | 1 | 39 |
| `Stmt::Assign` | 2 | 6 | 4 | 3 | 5 | 3 | 1 | 24 |
| `Stmt::SetField` | 4 | 6 | 3 | 3 | 5 | 4 | 1 | 26 |
| `Stmt::IndexSet` | 4 | 6 | 3 | 3 | 5 | 3 | 1 | 25 |
| `Stmt::Return` | 1 | 12 | 5 | 3 | 5 | 4 | 3 | 33 |
| `Stmt::Break` | 2 | 6 | 4 | 3 | 5 | 2 | 1 | 23 |
| `Stmt::Continue` | 1 | 6 | 4 | 3 | 5 | 2 | 1 | 22 |
| `Stmt::If` | 2 | 9 | 7 | 3 | 5 | 2 | 1 | 29 |
| `Stmt::IfLet` | 2 | 7 | 7 | 3 | 5 | 3 | 1 | 28 |
| `Stmt::While` | 2 | 9 | 6 | 3 | 5 | 2 | 1 | 28 |
| `Stmt::ForIn` | 1 | 10 | 6 | 3 | 5 | 3 | 1 | 29 |
| `Stmt::Drop` | 1 | 7 | 3 | 3 | 5 | 3 | 1 | 23 |
| `Stmt::Expr` | 2 | 6 | 4 | 3 | 5 | 4 | 1 | 25 |
| `Stmt::Region` | 1 | 9 | 6 | 3 | 5 | 2 | 1 | 27 |
| `Expr::Int` | 4 | 9 | 8 | 2 | 8 | 4 | 2 | 37 |
| `Expr::Byte` | 2 | 7 | 5 | 2 | 8 | 4 | 2 | 30 |
| `Expr::Float` | 2 | 7 | 7 | 2 | 8 | 3 | 2 | 31 |
| `Expr::Bool` | 4 | 5 | 7 | 2 | 8 | 3 | 2 | 31 |
| `Expr::Str` | 7 | 6 | 10 | 4 | 8 | 8 | 3 | 46 |
| `Expr::Var` | 25 | 23 | 23 | 3 | 24 | 31 | 1 | 130 |
| `Expr::Unary` | 4 | 8 | 6 | 2 | 7 | 2 | 2 | 31 |
| `Expr::Binary` | 3 | 7 | 13 | 3 | 8 | 2 | 1 | 37 |
| `Expr::Call` | 22 | 13 | 40 | 4 | 24 | 11 | 1 | 115 |
| `Expr::Match` | 7 | 10 | 16 | 4 | 7 | 4 | 1 | 49 |
| `Expr::IfExpr` | 1 | 8 | 14 | 2 | 6 | 2 | 1 | 34 |
| `Expr::Try` | 1 | 7 | 6 | 2 | 6 | 4 | 1 | 27 |
| `Expr::StructLit` | 2 | 8 | 9 | 2 | 9 | 3 | 1 | 34 |
| `Expr::Field` | 6 | 7 | 17 | 3 | 14 | 3 | 1 | 51 |
| `Expr::TryConstruct` | 1 | 7 | 5 | 2 | 5 | 4 | 1 | 25 |
| `Expr::ArrayLit` | 5 | 7 | 10 | 2 | 9 | 4 | 2 | 39 |
| `Expr::MapLit` | 3 | 5 | 6 | 2 | 6 | 3 | 1 | 26 |
| `Expr::Spawn` | 1 | 7 | 6 | 2 | 6 | 5 | 1 | 28 |
| `Expr::Lambda` | 1 | 10 | 6 | 3 | 9 | 8 | 1 | 38 |
| `Expr::Consume` | 1 | 5 | 10 | 2 | 11 | 6 | 1 | 36 |
| `Pattern::Variant` | 11 | 5 | 3 | 0 | 1 | 6 | 1 | 27 |
| `Pattern::Success` | 1 | 5 | 4 | 0 | 3 | 5 | 1 | 19 |
| `Pattern::Failure` | 1 | 4 | 2 | 0 | 2 | 3 | 1 | 13 |
| `Pattern::Other` | 1 | 3 | 1 | 0 | 1 | 4 | 1 | 11 |
|---|---|---|---|---|---|---|---|---|---|
...
| `Expr::Int` | 4 | 9 | 8 | 2 | 8 | 5 | 4 | 2 | 42 |
| `Expr::Byte` | 2 | 7 | 5 | 2 | 8 | 5 | 4 | 2 | 35 |
| `Expr::Float` | 2 | 7 | 7 | 2 | 8 | 5 | 3 | 2 | 36 |
| `Expr::Bool` | 4 | 5 | 7 | 2 | 8 | 5 | 3 | 2 | 36 |
| `Expr::Str` | 7 | 6 | 10 | 4 | 8 | 10 | 8 | 3 | 56 |
| `Expr::Var` | 25 | 23 | 23 | 3 | 24 | 33 | 31 | 1 | 163 |
| `Expr::Unary` | 4 | 8 | 6 | 2 | 7 | 6 | 2 | 2 | 37 |
| `Expr::Binary` | 3 | 7 | 13 | 3 | 8 | 8 | 2 | 1 | 45 |
| `Expr::Call` | 22 | 13 | 40 | 4 | 24 | 12 | 11 | 1 | 127 |
| `Expr::Match` | 7 | 10 | 16 | 4 | 7 | 6 | 4 | 1 | 55 |
| `Expr::IfExpr` | 1 | 8 | 14 | 2 | 6 | 6 | 2 | 1 | 40 |
| `Expr::Try` | 1 | 7 | 6 | 2 | 6 | 6 | 4 | 1 | 33 |
| `Expr::StructLit` | 2 | 8 | 9 | 2 | 9 | 6 | 3 | 1 | 40 |
| `Expr::Field` | 6 | 7 | 17 | 3 | 14 | 8 | 3 | 1 | 59 |
| `Expr::TryConstruct` | 1 | 7 | 5 | 2 | 5 | 6 | 4 | 1 | 31 |
| `Expr::ArrayLit` | 5 | 7 | 10 | 2 | 9 | 7 | 4 | 2 | 46 |
| `Expr::MapLit` | 3 | 5 | 6 | 2 | 6 | 6 | 3 | 1 | 32 |
| `Expr::Spawn` | 1 | 7 | 6 | 2 | 6 | 6 | 5 | 1 | 34 |
| `Expr::Lambda` | 1 | 10 | 6 | 3 | 9 | 8 | 8 | 1 | 46 |
| `Expr::Consume` | 1 | 5 | 10 | 2 | 11 | 7 | 6 | 1 | 43 |
| `Pattern::Variant` | 11 | 5 | 3 | 0 | 1 | 4 | 6 | 1 | 31 |
| `Pattern::Success` | 1 | 5 | 4 | 0 | 3 | 4 | 5 | 1 | 23 |
| `Pattern::Failure` | 1 | 4 | 2 | 0 | 2 | 4 | 3 | 1 | 17 |
| `Pattern::Other` | 1 | 3 | 1 | 0 | 1 | 5 | 4 | 1 | 16 |

The `wasm` column fell by 19 in RFC-0125 §3 M5's one-reader slice, which is
where the total went from 1,609 to 1,590. Fourteen forms lost 21 mentions between
them and two gained one each. The losses are `peek`, the direct backend's
second expression typer, and the helpers that fed it: the emitter reads the
checker's record for an expression's type, so the arms are deleted. `Expr::Var`
alone lost five, because typing a name read a binding, a global, a capture, a
parameter and an impl. The two gains are `Expr::Int` and `Expr::Byte`, and they are the one rule the slice
had to state: a literal adapts to its position, so a literal operand does not
fix the width the operation computes at.

**The shape of this table is not RFC-0126's, and that is the finding.** The type
census ran from 7 mentions to 244, a factor of 35. This one runs from 31 to 202
if `Expr::Var` is counted and from 31 to 64 if it is not, and 34 of the 38 rows
sit between 31 and 61. A type constructor's cost tells you something about the
constructor. A form's cost mostly does not.

### 3.1.1 The floor, and what is above it

`Stmt::Continue` costs 31 mentions. A `continue` has no operand, no type, no
value, no ownership effect and no diagnostic of its own; the checker asks
whether a loop encloses it and every other pass steps over it. So **31 is the
price of existing**, and the rows above it pay 31 plus what they decide:

| form | all nine | above the floor | what the excess buys |
|---|---|---|---|
| `Stmt::Continue` | 31 | 0 | the floor |
| `Stmt::Break` | 32 | 1 | one more arm, in `own` |
| `Stmt::Drop` | 32 | 1 | RFC-0114's explicit reclaim |
| `Stmt::Let` | 51 | 20 | a binder, a type, a placement, a copy rule |
| `Stmt::Return` | 44 | 13 | the release of every live binding on the way out |

An expression's floor is 36 (`Expr::Try`, `Expr::TryConstruct`, `Expr::MapLit`),
and it is higher for the same reason a `Stmt` floor exists: an expression is
walked by more collectors than a statement is.

**Where the floor comes from.** It is not the deciders. Taking `Stmt::Region`'s
36 apart: two mentions are the parser building and the checker's own rule; the
rest are exhaustive walks that do nothing with a region except recurse into its
block — `bound_names`, `scan_append_block`, `collect_regex_block`,
`collect_strings_block`, `mount_calls_block`, `calls_block`, and a `line()`
match in each of four files. **About two thirds of every form's cost is walks
...
|---|---|---|---|---|---|---|---|
| `imports` | 1 | 19 | 0 | 0 | 5 | 1 | 26 |
| `type_decls` | 16 | 16 | 4 | 1 | 14 | 0 | 51 |
| `functions` | 2 | 18 | 22 | 1 | 12 | 15 | 70 |
| `protocols` | 1 | 11 | 7 | 0 | 8 | 0 | 27 |
| `contracts` | 0 | 11 | 4 | 0 | 0 | 0 | 15 |
| `impls` | 1 | 7 | 15 | 3 | 6 | 0 | 32 |
| `globals` | 1 | 12 | 14 | 1 | 2 | 0 | 30 |
| `tests` | 0 | 6 | 3 | 1 | 1 | 5 | 16 |
| `benches` | 0 | 6 | 3 | 1 | 1 | 6 | 17 |
|---|---|---|---|---|---|---|---|---|
| `imports` | 1 | 19 | 0 | 0 | 0 | 5 | 1 | 26 |
| `type_decls` | 16 | 16 | 4 | 1 | 5 | 14 | 0 | 56 |
| `functions` | 2 | 18 | 22 | 1 | 9 | 12 | 15 | 79 |
| `protocols` | 1 | 11 | 7 | 0 | 1 | 8 | 0 | 28 |
| `contracts` | 0 | 11 | 4 | 0 | 0 | 0 | 0 | 15 |
| `impls` | 1 | 7 | 15 | 3 | 23 | 6 | 0 | 55 |
| `globals` | 1 | 12 | 14 | 1 | 16 | 2 | 0 | 46 |
| `tests` | 0 | 6 | 3 | 1 | 1 | 1 | 5 | 17 |
| `benches` | 0 | 6 | 3 | 1 | 1 | 1 | 6 | 18 |
