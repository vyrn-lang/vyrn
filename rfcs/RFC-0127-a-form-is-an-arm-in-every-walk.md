...
1,205 mentions in eight files for 38 forms. The table is generated by
...
| `Stmt::If` | 2 | 8 | 4 | 0 | 8 | 3 | 1 | 1 | 27 |
| `Stmt::IfLet` | 2 | 7 | 4 | 0 | 8 | 3 | 2 | 1 | 27 |
| `Stmt::While` | 2 | 8 | 4 | 0 | 7 | 3 | 1 | 1 | 26 |
| `Stmt::ForIn` | 1 | 9 | 4 | 0 | 7 | 3 | 2 | 1 | 27 |
| `Stmt::Drop` | 1 | 6 | 2 | 0 | 6 | 3 | 2 | 1 | 21 |
| `Stmt::Expr` | 2 | 6 | 2 | 0 | 7 | 3 | 3 | 1 | 24 |
| `Stmt::Region` | 1 | 8 | 3 | 0 | 8 | 3 | 1 | 1 | 25 |
| `Expr::Int` | 4 | 9 | 6 | 0 | 8 | 2 | 3 | 2 | 34 |
| `Expr::Byte` | 2 | 7 | 4 | 0 | 8 | 2 | 3 | 2 | 28 |
| `Expr::Float` | 2 | 7 | 5 | 0 | 8 | 2 | 2 | 2 | 28 |
| `Expr::Bool` | 4 | 5 | 5 | 0 | 8 | 2 | 2 | 2 | 28 |
| `Expr::Str` | 7 | 6 | 5 | 0 | 8 | 2 | 7 | 3 | 38 |
| `Expr::Var` | 25 | 23 | 15 | 0 | 26 | 5 | 30 | 1 | 125 |
| `Expr::Unary` | 4 | 8 | 4 | 0 | 7 | 3 | 1 | 2 | 29 |
| `Expr::Binary` | 3 | 7 | 4 | 1 | 8 | 4 | 1 | 1 | 29 |
| `Expr::Call` | 22 | 13 | 11 | 1 | 26 | 4 | 10 | 1 | 88 |
| `Expr::Match` | 8 | 9 | 7 | 0 | 9 | 3 | 3 | 1 | 40 |
| `Expr::IfExpr` | 1 | 8 | 5 | 0 | 8 | 3 | 1 | 1 | 27 |
| `Expr::Try` | 1 | 7 | 3 | 0 | 6 | 3 | 3 | 1 | 24 |
| `Expr::StructLit` | 2 | 8 | 4 | 0 | 9 | 3 | 2 | 1 | 29 |
| `Expr::Field` | 6 | 7 | 11 | 0 | 14 | 3 | 2 | 1 | 44 |
| `Expr::TryConstruct` | 1 | 7 | 3 | 0 | 5 | 3 | 3 | 1 | 23 |
| `Expr::ArrayLit` | 5 | 7 | 4 | 0 | 8 | 4 | 3 | 2 | 33 |
| `Expr::MapLit` | 3 | 5 | 4 | 0 | 6 | 3 | 2 | 1 | 24 |
| `Expr::Spawn` | 1 | 7 | 3 | 0 | 7 | 3 | 4 | 1 | 26 |
| `Expr::Lambda` | 1 | 10 | 5 | 0 | 11 | 2 | 8 | 1 | 38 |
| `Expr::Consume` | 1 | 5 | 6 | 0 | 11 | 2 | 4 | 1 | 30 |
