...
1,766 mentions in nine files for 38 forms. The table is generated by
...
| form | parser | checker | movecheck | own | lower | native | wasm | interp | editor | all nine |
|---|---|---|---|---|---|---|---|---|---|---|
| `Stmt::Let` | 8 | 10 | 5 | 4 | 6 | 6 | 5 | 6 | 1 | 51 |
| `Stmt::Assign` | 2 | 6 | 4 | 3 | 5 | 6 | 3 | 3 | 1 | 33 |
| `Stmt::SetField` | 4 | 6 | 3 | 3 | 5 | 6 | 4 | 3 | 1 | 35 |
| `Stmt::IndexSet` | 4 | 6 | 3 | 3 | 5 | 6 | 3 | 3 | 1 | 34 |
| `Stmt::Return` | 1 | 12 | 5 | 3 | 5 | 8 | 4 | 3 | 3 | 44 |
| `Stmt::Break` | 2 | 6 | 4 | 3 | 5 | 6 | 2 | 3 | 1 | 32 |
| `Stmt::Continue` | 1 | 6 | 4 | 3 | 5 | 6 | 2 | 3 | 1 | 31 |
| `Stmt::If` | 2 | 9 | 7 | 3 | 5 | 6 | 2 | 3 | 1 | 38 |
| `Stmt::IfLet` | 2 | 7 | 7 | 3 | 5 | 6 | 3 | 3 | 1 | 37 |
| `Stmt::While` | 2 | 9 | 6 | 3 | 5 | 6 | 2 | 3 | 1 | 37 |
| `Stmt::ForIn` | 1 | 10 | 6 | 3 | 5 | 6 | 3 | 3 | 1 | 38 |
| `Stmt::Drop` | 1 | 7 | 3 | 3 | 5 | 6 | 3 | 3 | 1 | 32 |
| `Stmt::Expr` | 2 | 6 | 4 | 3 | 5 | 6 | 4 | 3 | 1 | 34 |
| `Stmt::Region` | 1 | 9 | 6 | 3 | 5 | 6 | 2 | 3 | 1 | 36 |
| `Expr::Int` | 4 | 9 | 8 | 2 | 8 | 5 | 3 | 5 | 2 | 46 |
| `Expr::Byte` | 2 | 7 | 5 | 2 | 8 | 5 | 3 | 3 | 2 | 37 |
| `Expr::Float` | 2 | 7 | 7 | 2 | 8 | 5 | 3 | 3 | 2 | 39 |
| `Expr::Bool` | 4 | 5 | 7 | 2 | 8 | 5 | 3 | 3 | 2 | 39 |
| `Expr::Str` | 7 | 6 | 10 | 4 | 8 | 10 | 8 | 3 | 3 | 59 |
| `Expr::Var` | 25 | 23 | 24 | 3 | 23 | 33 | 36 | 33 | 1 | 201 |
| `Expr::Unary` | 4 | 8 | 7 | 2 | 6 | 6 | 3 | 3 | 2 | 41 |
| `Expr::Binary` | 3 | 7 | 14 | 3 | 6 | 8 | 3 | 5 | 1 | 50 |
| `Expr::Call` | 22 | 13 | 41 | 4 | 20 | 12 | 13 | 12 | 1 | 138 |
| `Expr::Match` | 7 | 10 | 17 | 4 | 6 | 6 | 5 | 4 | 1 | 60 |
| `Expr::IfExpr` | 1 | 8 | 15 | 2 | 6 | 6 | 3 | 3 | 1 | 45 |
| `Expr::Try` | 1 | 7 | 6 | 2 | 5 | 6 | 5 | 3 | 1 | 36 |
| `Expr::StructLit` | 2 | 8 | 10 | 2 | 7 | 6 | 4 | 4 | 1 | 44 |
| `Expr::Field` | 6 | 7 | 17 | 3 | 12 | 8 | 3 | 7 | 1 | 64 |
| `Expr::TryConstruct` | 1 | 7 | 5 | 2 | 5 | 6 | 5 | 4 | 1 | 36 |
| `Expr::ArrayLit` | 5 | 7 | 11 | 2 | 6 | 7 | 6 | 3 | 2 | 49 |
| `Expr::MapLit` | 3 | 5 | 6 | 2 | 6 | 6 | 4 | 3 | 1 | 36 |
| `Expr::Spawn` | 1 | 7 | 6 | 2 | 6 | 6 | 6 | 3 | 1 | 38 |
| `Expr::Lambda` | 1 | 10 | 6 | 3 | 9 | 8 | 10 | 4 | 1 | 52 |
| `Expr::Consume` | 1 | 5 | 10 | 2 | 11 | 7 | 7 | 3 | 1 | 47 |
| `Pattern::Variant` | 11 | 5 | 3 | 0 | 1 | 4 | 6 | 6 | 1 | 37 |
| `Pattern::Success` | 1 | 5 | 4 | 0 | 3 | 4 | 5 | 1 | 1 | 24 |
| `Pattern::Failure` | 1 | 4 | 2 | 0 | 2 | 4 | 3 | 2 | 1 | 19 |
| `Pattern::Other` | 1 | 3 | 1 | 0 | 1 | 5 | 4 | 1 | 1 | 17 |
...
393 mentions in eight files. The rows are `Program`'s `Vec` fields, read out of
`ast.rs` by the test, so a tenth declaration form fails the census until it has
a row.

| declaration | parser | loader | checker | project | native | interp | editor | cli | all eight |
|---|---|---|---|---|---|---|---|---|---|
| `imports` | 1 | 19 | 0 | 0 | 0 | 0 | 5 | 1 | 26 |
| `type_decls` | 16 | 16 | 4 | 1 | 5 | 4 | 14 | 0 | 60 |
| `functions` | 2 | 18 | 22 | 1 | 9 | 5 | 12 | 15 | 84 |
| `protocols` | 1 | 11 | 7 | 0 | 1 | 1 | 8 | 0 | 29 |
| `contracts` | 0 | 11 | 4 | 0 | 0 | 2 | 0 | 0 | 17 |
| `impls` | 1 | 7 | 15 | 3 | 23 | 14 | 6 | 0 | 69 |
| `globals` | 1 | 12 | 14 | 1 | 16 | 25 | 2 | 0 | 71 |
| `tests` | 0 | 6 | 3 | 1 | 1 | 1 | 1 | 5 | 18 |
| `benches` | 0 | 6 | 3 | 1 | 1 | 1 | 1 | 6 | 19 |
