...
1,076 mentions in eight files for 38 forms. The table is generated by
...
| `Expr::Int` | 4 | 7 | 5 | 1 | 8 | 1 | 3 | 1 | 30 |
| `Expr::Byte` | 2 | 5 | 3 | 1 | 8 | 1 | 3 | 1 | 24 |
| `Expr::Float` | 2 | 5 | 4 | 1 | 8 | 1 | 2 | 1 | 24 |
| `Expr::Bool` | 4 | 3 | 4 | 1 | 8 | 1 | 2 | 1 | 24 |
| `Expr::Str` | 7 | 4 | 4 | 2 | 8 | 1 | 7 | 2 | 35 |
| `Expr::Var` | 25 | 22 | 19 | 1 | 25 | 4 | 30 | 0 | 126 |
| `Expr::Unary` | 4 | 4 | 3 | 1 | 7 | 1 | 1 | 1 | 22 |
| `Expr::Binary` | 3 | 3 | 5 | 2 | 8 | 2 | 1 | 0 | 24 |
| `Expr::Call` | 22 | 12 | 22 | 2 | 26 | 3 | 11 | 0 | 98 |
| `Expr::Match` | 8 | 5 | 11 | 2 | 9 | 1 | 3 | 0 | 39 |
| `Expr::IfExpr` | 1 | 4 | 9 | 1 | 8 | 1 | 1 | 0 | 25 |
| `Expr::Try` | 1 | 3 | 3 | 1 | 6 | 1 | 3 | 0 | 18 |
| `Expr::StructLit` | 2 | 4 | 5 | 1 | 9 | 1 | 2 | 0 | 24 |
| `Expr::Field` | 6 | 3 | 12 | 1 | 14 | 1 | 2 | 0 | 39 |
| `Expr::TryConstruct` | 1 | 4 | 2 | 1 | 5 | 1 | 3 | 0 | 17 |
| `Expr::ArrayLit` | 5 | 3 | 3 | 1 | 9 | 2 | 3 | 1 | 27 |
| `Expr::MapLit` | 3 | 3 | 3 | 1 | 6 | 2 | 2 | 0 | 20 |
| `Expr::Spawn` | 1 | 6 | 2 | 1 | 7 | 1 | 4 | 0 | 22 |
| `Expr::Lambda` | 1 | 7 | 6 | 2 | 9 | 3 | 8 | 1 | 37 |
| `Expr::Consume` | 1 | 3 | 7 | 1 | 11 | 1 | 5 | 0 | 29 |
...
An expression's floor is 17 (`Expr::TryConstruct`), and it is higher for the
