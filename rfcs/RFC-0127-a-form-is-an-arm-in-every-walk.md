...
1,184 mentions in eight files for 38 forms. The table is generated by
...
|---|---|---|---|---|---|---|---|---|---|
| `Stmt::Let` | 8 | 10 | 2 | 0 | 9 | 3 | 4 | 1 | 37 |
| `Stmt::Assign` | 2 | 6 | 2 | 0 | 7 | 3 | 2 | 1 | 23 |
| `Stmt::SetField` | 4 | 6 | 2 | 0 | 6 | 3 | 3 | 1 | 25 |
| `Stmt::IndexSet` | 4 | 6 | 2 | 0 | 6 | 3 | 2 | 1 | 24 |
| `Stmt::Return` | 1 | 12 | 2 | 0 | 8 | 5 | 3 | 3 | 34 |
| `Stmt::Break` | 2 | 6 | 1 | 0 | 8 | 3 | 1 | 1 | 22 |
| `Stmt::Continue` | 1 | 6 | 1 | 0 | 8 | 3 | 1 | 1 | 21 |
| `Stmt::If` | 2 | 8 | 3 | 0 | 8 | 3 | 1 | 1 | 26 |
| `Stmt::IfLet` | 2 | 7 | 3 | 0 | 8 | 3 | 2 | 1 | 26 |
| `Stmt::While` | 2 | 8 | 3 | 0 | 7 | 3 | 1 | 1 | 25 |
| `Stmt::ForIn` | 1 | 9 | 3 | 0 | 7 | 3 | 2 | 1 | 26 |
| `Stmt::Drop` | 1 | 6 | 2 | 0 | 6 | 3 | 2 | 1 | 21 |
| `Stmt::Expr` | 2 | 6 | 2 | 0 | 7 | 3 | 3 | 1 | 24 |
| `Stmt::Region` | 1 | 8 | 2 | 0 | 8 | 3 | 1 | 1 | 24 |
| `Expr::Int` | 4 | 9 | 5 | 0 | 8 | 2 | 3 | 2 | 33 |
| `Expr::Byte` | 2 | 7 | 4 | 0 | 8 | 2 | 3 | 2 | 28 |
| `Expr::Float` | 2 | 7 | 4 | 0 | 8 | 2 | 2 | 2 | 27 |
| `Expr::Bool` | 4 | 5 | 4 | 0 | 8 | 2 | 2 | 2 | 27 |
| `Expr::Str` | 7 | 6 | 4 | 0 | 8 | 2 | 7 | 3 | 37 |
| `Expr::Var` | 25 | 23 | 13 | 0 | 26 | 5 | 30 | 1 | 123 |
| `Expr::Unary` | 4 | 8 | 3 | 0 | 7 | 3 | 1 | 2 | 28 |
| `Expr::Binary` | 3 | 7 | 3 | 1 | 8 | 4 | 1 | 1 | 28 |
| `Expr::Call` | 22 | 13 | 10 | 1 | 26 | 4 | 10 | 1 | 87 |
| `Expr::Match` | 8 | 9 | 6 | 0 | 9 | 3 | 3 | 1 | 39 |
| `Expr::IfExpr` | 1 | 8 | 4 | 0 | 8 | 3 | 1 | 1 | 26 |
| `Expr::Try` | 1 | 7 | 3 | 0 | 6 | 3 | 3 | 1 | 24 |
| `Expr::StructLit` | 2 | 8 | 3 | 0 | 9 | 3 | 2 | 1 | 28 |
| `Expr::Field` | 6 | 7 | 11 | 0 | 14 | 3 | 2 | 1 | 44 |
| `Expr::TryConstruct` | 1 | 7 | 3 | 0 | 5 | 3 | 3 | 1 | 23 |
| `Expr::ArrayLit` | 5 | 7 | 3 | 0 | 8 | 4 | 3 | 2 | 32 |
| `Expr::MapLit` | 3 | 5 | 3 | 0 | 6 | 3 | 2 | 1 | 23 |
| `Expr::Spawn` | 1 | 7 | 3 | 0 | 7 | 3 | 4 | 1 | 26 |
| `Expr::Lambda` | 1 | 10 | 5 | 0 | 11 | 2 | 8 | 1 | 38 |
| `Expr::Consume` | 1 | 5 | 5 | 0 | 11 | 2 | 4 | 1 | 29 |
...
`Stmt::Drop` costs 23 mentions. A `drop` names one binding, and it has no type,
no value and no diagnostic of its own past the move rule every other form pays;
the checker asks whether the name is a binding and every other pass steps over
it. So **23 is the price of existing**, and the rows above it pay 23 plus what
they decide:

| form | all eight | above the floor | what the excess buys |
|---|---|---|---|
| `Stmt::Drop` | 23 | 0 | the floor |
| `Stmt::Continue` | 24 | 1 | the emitter gives back at this exit from the core's row as well as from the source |
| `Stmt::Break` | 25 | 2 | that one, and one more arm in `own` |
| `Stmt::Let` | 41 | 18 | a binder, a type, a placement, a copy rule |
| `Stmt::Return` | 37 | 14 | the release of every live binding on the way out |

The floor was 21 when §3.1's pin was last recomputed and this table said 22, so
it had drifted by one before the RFC-0125 §3 M3 interleave slice moved it to 23
— which is the preamble's own claim about an unpinned table, and it is unpinned
still. What moved it is one arm per statement form in `direct.rs`, where the
emitter names each one to count how many occurrences its own arm still emits.
Which form HOLDS the floor changed with §3 M3's release slice. `Stmt::Continue`
held it and is one above it now, because the emitter gives back at a `continue`
from the core's own row as well as from the source statement, and `Stmt::Drop`
holds it instead: an explicit reclaim is the one statement form no walk decides
anything about.
