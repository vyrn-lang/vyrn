...
983 mentions in eight files for 38 forms. The table is generated by
...
|---|---|---|---|---|---|---|---|---|---|
| `Stmt::Let` | 8 | 6 | 2 | 0 | 8 | 2 | 7 | 1 | 34 |
| `Stmt::Assign` | 3 | 4 | 2 | 0 | 6 | 1 | 5 | 0 | 21 |
| `Stmt::SetField` | 5 | 4 | 2 | 0 | 5 | 1 | 3 | 0 | 20 |
| `Stmt::IndexSet` | 4 | 4 | 2 | 0 | 5 | 1 | 2 | 0 | 18 |
| `Stmt::Return` | 1 | 6 | 2 | 0 | 7 | 2 | 6 | 1 | 25 |
| `Stmt::Break` | 2 | 2 | 1 | 0 | 7 | 1 | 4 | 0 | 17 |
| `Stmt::Continue` | 1 | 2 | 1 | 0 | 7 | 1 | 4 | 0 | 16 |
| `Stmt::If` | 2 | 4 | 3 | 0 | 7 | 1 | 4 | 0 | 21 |
| `Stmt::IfLet` | 2 | 3 | 3 | 0 | 7 | 2 | 5 | 1 | 23 |
| `Stmt::While` | 2 | 4 | 3 | 0 | 6 | 1 | 4 | 0 | 20 |
| `Stmt::ForIn` | 1 | 5 | 3 | 0 | 6 | 2 | 5 | 1 | 23 |
| `Stmt::Drop` | 1 | 4 | 2 | 0 | 5 | 1 | 4 | 0 | 17 |
| `Stmt::Expr` | 2 | 2 | 2 | 0 | 6 | 1 | 6 | 0 | 19 |
| `Stmt::Region` | 1 | 4 | 2 | 0 | 7 | 1 | 1 | 0 | 16 |
...
`Stmt::Continue` costs 16 mentions. A `continue` has no operand, no type, no
value, no ownership effect and no diagnostic of its own; the checker asks
whether a loop encloses it and every other pass steps over it. So **16 is the
price of existing**, and the rows above it pay 16 plus what they decide:

| form | all eight | above the floor | what the excess buys |
|---|---|---|---|
| `Stmt::Continue` | 16 | 0 | the floor |
| `Stmt::Break` | 17 | 1 | one more arm, in `own` |
| `Stmt::Drop` | 17 | 1 | RFC-0114's explicit reclaim and the capture rule, net of the arms `typed`'s loop scan gives a `continue` and not a `drop` |
| `Stmt::Let` | 34 | 18 | a binder, a type, a placement, a copy rule |
| `Stmt::Return` | 25 | 9 | the release of every live binding on the way out |

An expression's floor is 14 (`Expr::Try` and `Expr::TryConstruct`). A pattern is
walked by fewer passes than either, and two rows are under the statement floor:
`Pattern::Other` at 13 and `Pattern::Failure` at 15.

**Where the floor comes from.** It is not the deciders. Taking `Stmt::Region`'s
16 apart: two mentions are the parser building and the checker's own rule; the
