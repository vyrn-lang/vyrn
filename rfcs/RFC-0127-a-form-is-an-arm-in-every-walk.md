...
861 mentions in eight files for 37 forms. The table is generated by
...
|---|---|---|---|---|---|---|---|---|---|
| `Stmt::Let` | 7 | 4 | 1 | 0 | 13 | 0 | 10 | 0 | 35 |
| `Stmt::Assign` | 3 | 3 | 1 | 0 | 6 | 0 | 5 | 0 | 18 |
| `Stmt::SetField` | 4 | 3 | 1 | 0 | 8 | 0 | 3 | 0 | 19 |
| `Stmt::IndexSet` | 3 | 3 | 2 | 0 | 8 | 0 | 2 | 0 | 18 |
| `Stmt::Return` | 1 | 5 | 1 | 0 | 8 | 0 | 6 | 1 | 22 |
...
| `Stmt::Region` | 1 | 3 | 1 | 0 | 7 | 0 | 3 | 0 | 15 |
| `Expr::Int` | 4 | 6 | 1 | 0 | 7 | 0 | 5 | 1 | 24 |
| `Expr::Byte` | 2 | 3 | 1 | 0 | 7 | 0 | 5 | 1 | 19 |
| `Expr::Float` | 2 | 4 | 1 | 0 | 7 | 0 | 4 | 1 | 19 |
| `Expr::Bool` | 4 | 2 | 1 | 0 | 7 | 0 | 4 | 1 | 19 |
| `Expr::Str` | 7 | 3 | 1 | 0 | 7 | 0 | 9 | 2 | 29 |
| `Expr::Var` | 25 | 17 | 4 | 0 | 37 | 1 | 30 | 0 | 114 |
| `Expr::Unary` | 4 | 3 | 1 | 0 | 6 | 0 | 3 | 1 | 18 |
| `Expr::Binary` | 3 | 2 | 1 | 1 | 9 | 0 | 3 | 0 | 19 |
| `Expr::Call` | 23 | 12 | 8 | 1 | 34 | 1 | 10 | 0 | 89 |
| `Expr::Match` | 8 | 5 | 4 | 0 | 8 | 0 | 3 | 0 | 28 |
| `Expr::IfExpr` | 1 | 3 | 2 | 0 | 7 | 0 | 1 | 0 | 14 |
| `Expr::Try` | 1 | 2 | 1 | 0 | 5 | 0 | 3 | 0 | 12 |
| `Expr::StructLit` | 2 | 3 | 1 | 0 | 8 | 0 | 3 | 0 | 17 |
| `Expr::Field` | 7 | 2 | 4 | 0 | 13 | 0 | 2 | 0 | 28 |
