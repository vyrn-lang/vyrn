...
1,148 mentions in eight files for 38 forms. The table is generated by
...
|---|---|---|---|---|---|---|---|---|---|
| `Stmt::Let` | 8 | 8 | 3 | 2 | 9 | 2 | 4 | 1 | 37 |
| `Stmt::Assign` | 2 | 5 | 2 | 1 | 7 | 1 | 2 | 0 | 20 |
| `Stmt::SetField` | 4 | 5 | 2 | 1 | 6 | 1 | 3 | 0 | 22 |
| `Stmt::IndexSet` | 4 | 5 | 2 | 1 | 6 | 1 | 2 | 0 | 21 |
| `Stmt::Return` | 1 | 9 | 2 | 1 | 8 | 2 | 3 | 1 | 27 |
| `Stmt::Break` | 2 | 4 | 1 | 1 | 8 | 1 | 1 | 0 | 18 |
| `Stmt::Continue` | 1 | 4 | 1 | 1 | 8 | 1 | 1 | 0 | 17 |
| `Stmt::If` | 2 | 7 | 4 | 1 | 8 | 1 | 1 | 0 | 24 |
| `Stmt::IfLet` | 2 | 5 | 4 | 1 | 8 | 2 | 2 | 1 | 25 |
| `Stmt::While` | 2 | 7 | 4 | 1 | 7 | 1 | 1 | 0 | 23 |
| `Stmt::ForIn` | 1 | 8 | 4 | 1 | 7 | 2 | 2 | 1 | 26 |
| `Stmt::Drop` | 1 | 6 | 2 | 1 | 6 | 1 | 2 | 0 | 19 |
| `Stmt::Expr` | 2 | 4 | 2 | 1 | 7 | 1 | 3 | 0 | 20 |
| `Stmt::Region` | 1 | 7 | 3 | 1 | 8 | 1 | 1 | 0 | 22 |
| `Expr::Int` | 4 | 8 | 6 | 1 | 8 | 1 | 3 | 1 | 32 |
| `Expr::Byte` | 2 | 6 | 4 | 1 | 8 | 1 | 3 | 1 | 26 |
| `Expr::Float` | 2 | 6 | 5 | 1 | 8 | 1 | 2 | 1 | 26 |
| `Expr::Bool` | 4 | 4 | 5 | 1 | 8 | 1 | 2 | 1 | 26 |
| `Expr::Str` | 7 | 5 | 5 | 2 | 8 | 1 | 7 | 2 | 37 |
| `Expr::Var` | 25 | 22 | 19 | 1 | 25 | 4 | 30 | 0 | 126 |
| `Expr::Unary` | 4 | 6 | 4 | 1 | 7 | 1 | 1 | 1 | 25 |
| `Expr::Binary` | 3 | 5 | 6 | 2 | 8 | 2 | 1 | 0 | 27 |
| `Expr::Call` | 22 | 13 | 23 | 2 | 26 | 3 | 11 | 0 | 100 |
| `Expr::Match` | 8 | 7 | 11 | 2 | 9 | 1 | 3 | 0 | 41 |
| `Expr::IfExpr` | 1 | 6 | 10 | 1 | 8 | 1 | 1 | 0 | 28 |
| `Expr::Try` | 1 | 5 | 4 | 1 | 6 | 1 | 3 | 0 | 21 |
| `Expr::StructLit` | 2 | 6 | 6 | 1 | 9 | 1 | 2 | 0 | 27 |
| `Expr::Field` | 6 | 5 | 13 | 1 | 14 | 1 | 2 | 0 | 42 |
| `Expr::TryConstruct` | 1 | 6 | 3 | 1 | 5 | 1 | 3 | 0 | 20 |
| `Expr::ArrayLit` | 5 | 5 | 4 | 1 | 9 | 2 | 3 | 1 | 30 |
| `Expr::MapLit` | 3 | 4 | 4 | 1 | 6 | 2 | 2 | 0 | 22 |
| `Expr::Spawn` | 1 | 7 | 3 | 1 | 7 | 1 | 4 | 0 | 24 |
| `Expr::Lambda` | 1 | 9 | 7 | 2 | 9 | 3 | 8 | 1 | 40 |
| `Expr::Consume` | 1 | 4 | 8 | 1 | 11 | 1 | 5 | 0 | 31 |
...
`Stmt::Continue` costs 17 mentions. A `continue` has no operand, no type, no
value, no ownership effect and no diagnostic of its own; the checker asks
whether a loop encloses it and every other pass steps over it. So **17 is the
price of existing**, and the rows above it pay 17 plus what they decide:

| form | all eight | above the floor | what the excess buys |
|---|---|---|---|
| `Stmt::Continue` | 17 | 0 | the floor |
| `Stmt::Break` | 18 | 1 | one more arm, in `own` |
| `Stmt::Drop` | 19 | 2 | RFC-0114's explicit reclaim, and the capture rule |
| `Stmt::Let` | 37 | 20 | a binder, a type, a placement, a copy rule |
| `Stmt::Return` | 27 | 10 | the release of every live binding on the way out |

An expression's floor is 20 (`Expr::TryConstruct`), and it is higher for the
...
22 apart: two mentions are the parser building and the checker's own rule; the
