...
1,222 mentions in eight files for 38 forms. The table is generated by
...
| `Stmt::Return` | 1 | 11 | 2 | 1 | 8 | 4 | 3 | 1 | 31 |
| `Stmt::Break` | 2 | 5 | 1 | 1 | 8 | 2 | 1 | 0 | 20 |
| `Stmt::Continue` | 1 | 5 | 1 | 1 | 8 | 2 | 1 | 0 | 19 |
| `Stmt::If` | 2 | 8 | 4 | 1 | 8 | 2 | 1 | 0 | 26 |
| `Stmt::IfLet` | 2 | 6 | 4 | 1 | 8 | 3 | 2 | 1 | 27 |
| `Stmt::While` | 2 | 8 | 4 | 1 | 7 | 2 | 1 | 0 | 25 |
| `Stmt::ForIn` | 1 | 9 | 4 | 1 | 7 | 3 | 2 | 1 | 28 |
| `Stmt::Drop` | 1 | 6 | 2 | 1 | 6 | 2 | 2 | 0 | 20 |
| `Stmt::Expr` | 2 | 5 | 2 | 1 | 7 | 2 | 3 | 0 | 22 |
| `Stmt::Region` | 1 | 8 | 3 | 1 | 8 | 2 | 1 | 0 | 24 |
| `Expr::Int` | 4 | 8 | 7 | 1 | 8 | 1 | 3 | 1 | 33 |
| `Expr::Byte` | 2 | 6 | 5 | 1 | 8 | 1 | 3 | 1 | 27 |
| `Expr::Float` | 2 | 6 | 6 | 1 | 8 | 1 | 2 | 1 | 27 |
| `Expr::Bool` | 4 | 4 | 6 | 1 | 8 | 1 | 2 | 1 | 27 |
| `Expr::Str` | 7 | 5 | 6 | 2 | 8 | 1 | 7 | 2 | 38 |
| `Expr::Var` | 25 | 22 | 19 | 1 | 25 | 4 | 30 | 0 | 126 |
| `Expr::Unary` | 4 | 7 | 6 | 1 | 7 | 2 | 1 | 1 | 29 |
| `Expr::Binary` | 3 | 6 | 8 | 2 | 8 | 3 | 1 | 0 | 31 |
| `Expr::Call` | 22 | 13 | 25 | 2 | 26 | 3 | 11 | 0 | 102 |
| `Expr::Match` | 8 | 8 | 13 | 2 | 9 | 2 | 3 | 0 | 45 |
| `Expr::IfExpr` | 1 | 7 | 12 | 1 | 8 | 2 | 1 | 0 | 32 |
| `Expr::Try` | 1 | 6 | 6 | 1 | 6 | 2 | 3 | 0 | 25 |
| `Expr::StructLit` | 2 | 7 | 8 | 1 | 9 | 2 | 2 | 0 | 31 |
| `Expr::Field` | 6 | 6 | 15 | 1 | 14 | 2 | 2 | 0 | 46 |
| `Expr::TryConstruct` | 1 | 7 | 5 | 1 | 5 | 2 | 3 | 0 | 24 |
| `Expr::ArrayLit` | 5 | 6 | 6 | 1 | 9 | 3 | 3 | 1 | 34 |
| `Expr::MapLit` | 3 | 4 | 6 | 1 | 6 | 2 | 2 | 0 | 24 |
| `Expr::Spawn` | 1 | 7 | 5 | 1 | 7 | 2 | 4 | 0 | 27 |
| `Expr::Lambda` | 1 | 9 | 6 | 2 | 9 | 2 | 8 | 1 | 38 |
| `Expr::Consume` | 1 | 4 | 10 | 1 | 11 | 1 | 5 | 0 | 33 |
...
`Stmt::Continue` costs 19 mentions. A `continue` has no operand, no type, no
value, no ownership effect and no diagnostic of its own; the checker asks
whether a loop encloses it and every other pass steps over it. So **19 is the
price of existing**, and the rows above it pay 19 plus what they decide:

| form | all eight | above the floor | what the excess buys |
|---|---|---|---|
| `Stmt::Continue` | 19 | 0 | the floor |
| `Stmt::Break` | 20 | 1 | one more arm, in `own` |
| `Stmt::Drop` | 20 | 1 | RFC-0114's explicit reclaim |
| `Stmt::Let` | 39 | 20 | a binder, a type, a placement, a copy rule |
| `Stmt::Return` | 31 | 12 | the release of every live binding on the way out |

An expression's floor is 24 (`Expr::TryConstruct`), and it is higher for the
...
24 apart: two mentions are the parser building and the checker's own rule; the
