...
1,252 mentions in eight files for 38 forms. The table is generated by
...
|---|---|---|---|---|---|---|---|---|---|
| `Stmt::Let` | 8 | 9 | 3 | 2 | 9 | 3 | 4 | 1 | 39 |
| `Stmt::Assign` | 2 | 5 | 2 | 1 | 7 | 3 | 2 | 0 | 22 |
| `Stmt::SetField` | 4 | 5 | 2 | 1 | 6 | 3 | 3 | 0 | 24 |
| `Stmt::IndexSet` | 4 | 5 | 2 | 1 | 6 | 3 | 2 | 0 | 23 |
| `Stmt::Return` | 1 | 11 | 2 | 1 | 8 | 5 | 3 | 1 | 32 |
| `Stmt::Break` | 2 | 5 | 1 | 1 | 8 | 3 | 1 | 0 | 21 |
| `Stmt::Continue` | 1 | 5 | 1 | 1 | 8 | 3 | 1 | 0 | 20 |
| `Stmt::If` | 2 | 8 | 4 | 1 | 8 | 3 | 1 | 0 | 27 |
| `Stmt::IfLet` | 2 | 6 | 4 | 1 | 8 | 3 | 2 | 1 | 27 |
| `Stmt::While` | 2 | 8 | 4 | 1 | 7 | 3 | 1 | 0 | 26 |
| `Stmt::ForIn` | 1 | 9 | 4 | 1 | 7 | 3 | 2 | 1 | 28 |
| `Stmt::Drop` | 1 | 6 | 2 | 1 | 6 | 3 | 2 | 0 | 21 |
| `Stmt::Expr` | 2 | 5 | 2 | 1 | 7 | 3 | 3 | 0 | 23 |
| `Stmt::Region` | 1 | 8 | 3 | 1 | 8 | 3 | 1 | 0 | 25 |
| `Expr::Int` | 4 | 8 | 7 | 1 | 8 | 2 | 3 | 1 | 34 |
| `Expr::Byte` | 2 | 6 | 5 | 1 | 8 | 2 | 3 | 1 | 28 |
| `Expr::Float` | 2 | 6 | 6 | 1 | 8 | 2 | 2 | 1 | 28 |
| `Expr::Bool` | 4 | 4 | 6 | 1 | 8 | 2 | 2 | 1 | 28 |
| `Expr::Str` | 7 | 5 | 6 | 2 | 8 | 2 | 7 | 2 | 39 |
| `Expr::Var` | 25 | 22 | 19 | 1 | 25 | 5 | 30 | 0 | 127 |
| `Expr::Unary` | 4 | 7 | 6 | 1 | 7 | 3 | 1 | 1 | 30 |
| `Expr::Binary` | 3 | 6 | 8 | 2 | 8 | 4 | 1 | 0 | 32 |
| `Expr::Call` | 22 | 13 | 25 | 2 | 26 | 4 | 11 | 0 | 103 |
| `Expr::Match` | 8 | 8 | 13 | 2 | 9 | 3 | 3 | 0 | 46 |
| `Expr::IfExpr` | 1 | 7 | 12 | 1 | 8 | 3 | 1 | 0 | 33 |
| `Expr::Try` | 1 | 6 | 6 | 1 | 6 | 3 | 3 | 0 | 26 |
| `Expr::StructLit` | 2 | 7 | 8 | 1 | 9 | 3 | 2 | 0 | 32 |
| `Expr::Field` | 6 | 6 | 15 | 1 | 14 | 3 | 2 | 0 | 47 |
| `Expr::TryConstruct` | 1 | 7 | 5 | 1 | 5 | 3 | 3 | 0 | 25 |
| `Expr::ArrayLit` | 5 | 6 | 6 | 1 | 9 | 4 | 3 | 1 | 35 |
| `Expr::MapLit` | 3 | 4 | 6 | 1 | 6 | 3 | 2 | 0 | 25 |
| `Expr::Spawn` | 1 | 7 | 5 | 1 | 7 | 3 | 4 | 0 | 28 |
| `Expr::Lambda` | 1 | 9 | 6 | 2 | 9 | 2 | 8 | 1 | 38 |
| `Expr::Consume` | 1 | 4 | 10 | 1 | 11 | 2 | 5 | 0 | 34 |
...
`Stmt::Continue` costs 20 mentions. A `continue` has no operand, no type, no
value, no ownership effect and no diagnostic of its own; the checker asks
whether a loop encloses it and every other pass steps over it. So **20 is the
price of existing**, and the rows above it pay 20 plus what they decide:

| form | all eight | above the floor | what the excess buys |
|---|---|---|---|
| `Stmt::Continue` | 20 | 0 | the floor |
| `Stmt::Break` | 21 | 1 | one more arm, in `own` |
| `Stmt::Drop` | 21 | 1 | RFC-0114's explicit reclaim |
| `Stmt::Let` | 39 | 19 | a binder, a type, a placement, a copy rule |
| `Stmt::Return` | 32 | 12 | the release of every live binding on the way out |

An expression's floor is 25 (`Expr::TryConstruct`), and it is higher for the
...
25 apart: two mentions are the parser building and the checker's own rule; the
rest are exhaustive walks that do nothing with a region except recurse into its
block — `bound_names`, `scan_append_block`, and a `line()` match in each of four
files. It was 33 over six such walks: `collect_regex_block`,
