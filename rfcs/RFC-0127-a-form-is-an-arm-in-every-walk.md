...
1,271 mentions in eight files for 38 forms. The table is generated by
...
|---|---|---|---|---|---|---|---|---|---|
| `Stmt::Let` | 8 | 10 | 3 | 0 | 9 | 3 | 7 | 1 | 41 |
| `Stmt::Assign` | 2 | 6 | 2 | 0 | 7 | 3 | 5 | 1 | 26 |
| `Stmt::SetField` | 4 | 6 | 2 | 0 | 6 | 3 | 3 | 1 | 25 |
| `Stmt::IndexSet` | 4 | 6 | 2 | 0 | 6 | 3 | 2 | 1 | 24 |
| `Stmt::Return` | 1 | 12 | 2 | 0 | 8 | 5 | 6 | 3 | 37 |
| `Stmt::Break` | 2 | 6 | 1 | 0 | 8 | 3 | 4 | 1 | 25 |
| `Stmt::Continue` | 1 | 6 | 1 | 0 | 8 | 3 | 4 | 1 | 24 |
| `Stmt::If` | 2 | 8 | 4 | 0 | 8 | 3 | 4 | 1 | 30 |
| `Stmt::IfLet` | 2 | 7 | 4 | 0 | 8 | 3 | 5 | 1 | 30 |
| `Stmt::While` | 2 | 8 | 4 | 0 | 7 | 3 | 4 | 1 | 29 |
| `Stmt::ForIn` | 1 | 9 | 4 | 0 | 7 | 3 | 5 | 1 | 30 |
| `Stmt::Drop` | 1 | 6 | 2 | 0 | 6 | 3 | 4 | 1 | 23 |
| `Stmt::Expr` | 2 | 6 | 2 | 0 | 7 | 3 | 6 | 1 | 27 |
| `Stmt::Region` | 1 | 8 | 3 | 0 | 8 | 3 | 1 | 1 | 25 |
| `Expr::Int` | 4 | 9 | 6 | 0 | 8 | 2 | 5 | 2 | 36 |
| `Expr::Byte` | 2 | 7 | 4 | 0 | 8 | 2 | 5 | 2 | 30 |
| `Expr::Float` | 2 | 7 | 5 | 0 | 8 | 2 | 4 | 2 | 30 |
| `Expr::Bool` | 4 | 5 | 5 | 0 | 8 | 2 | 4 | 2 | 30 |
| `Expr::Str` | 7 | 6 | 5 | 0 | 8 | 2 | 9 | 3 | 40 |
| `Expr::Var` | 25 | 23 | 15 | 0 | 25 | 5 | 32 | 1 | 126 |
| `Expr::Unary` | 4 | 8 | 5 | 0 | 7 | 3 | 3 | 2 | 32 |
| `Expr::Binary` | 3 | 7 | 5 | 1 | 8 | 4 | 3 | 1 | 32 |
| `Expr::Call` | 22 | 13 | 14 | 1 | 27 | 4 | 10 | 1 | 92 |
| `Expr::Match` | 8 | 9 | 9 | 0 | 9 | 3 | 3 | 1 | 42 |
| `Expr::IfExpr` | 1 | 8 | 7 | 0 | 8 | 3 | 1 | 1 | 29 |
| `Expr::Try` | 1 | 7 | 4 | 0 | 6 | 3 | 3 | 1 | 25 |
| `Expr::StructLit` | 2 | 8 | 6 | 0 | 9 | 3 | 2 | 1 | 31 |
| `Expr::Field` | 6 | 7 | 13 | 0 | 14 | 3 | 2 | 1 | 46 |
| `Expr::TryConstruct` | 1 | 7 | 4 | 0 | 5 | 3 | 3 | 1 | 24 |
| `Expr::ArrayLit` | 5 | 7 | 5 | 0 | 9 | 4 | 3 | 2 | 35 |
| `Expr::MapLit` | 3 | 5 | 5 | 0 | 6 | 3 | 2 | 1 | 25 |
| `Expr::Spawn` | 1 | 7 | 4 | 0 | 7 | 3 | 4 | 1 | 27 |
| `Expr::Lambda` | 1 | 10 | 5 | 0 | 9 | 2 | 8 | 1 | 36 |
| `Expr::Consume` | 1 | 5 | 7 | 0 | 11 | 2 | 4 | 1 | 31 |
