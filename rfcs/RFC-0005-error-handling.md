...
- **Retired:** the concurrency half. `spawn` and `Task<T>` left the language on
  2026-09-11 because every engine ran a spawned call eagerly. Read every
  `spawn` below as history.
