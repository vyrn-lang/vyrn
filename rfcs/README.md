...
| [0125](RFC-0125-a-rule-is-stated-once.md) | a rule is stated once | Draft; a named, place-based core, a kernel of three judgments, one emitter and a runtime in Vyrn — M0 to M6 landed, M7 (every body lowers whole) is the measured gate, and the probe that motivates it is in §1.4 |
