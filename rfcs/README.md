...
| [0125](RFC-0125-a-rule-is-stated-once.md) | a rule is stated once | Draft; a named, place-based core, a kernel of three judgments, one emitter and a runtime in Vyrn — M0 to M7 landed; M7 deleted the AST walk (#545), and the probe that motivates it is in §1.4 |
