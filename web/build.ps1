...
foreach ($name in "fib", "enum", "reflection", "jsonschema", "externdemo", "externdemo2", "eventloop") {
...
Write-Host "built: fib enum reflection jsonschema externdemo externdemo2 eventloop -> web\*.wasm"
