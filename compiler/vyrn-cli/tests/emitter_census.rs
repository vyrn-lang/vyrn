...
fn what_the_emitter_reads_is_what_the_rfc_records() {
    ...
    let want = vec![
        ("neither", 51, 6561, 0, 0),
        ("the core's rows", 5, 2099, 0, 21),
        ("the source, and the core says it too", 1, 81, 1, 0),
        ("the source, and the core has no row", 10, 1956, 81, 0),
        ("both, for two questions", 15, 9277, 105, 238),
    ];
