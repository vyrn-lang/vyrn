...
fn the_emitter_census_is_what_the_rfc_records() {
    ...
    .collect();
    let want = vec![
        ("the mapping §2.3 names", 9199, 748),
        ("a decision §2.3 says it must not make", 1256, 214),
        ("the runtime it emits by hand", 625, 7),
        ("one block per builtin name", 4704, 933),
